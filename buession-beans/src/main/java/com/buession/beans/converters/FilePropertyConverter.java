...
public final class FilePropertyConverter extends AbstractPropertyConverter<File> {
	...
	@Override
	protected File convertToType(final Class<?> sourceType, final Object value, final Class<File> targetType) {
		...
		throw conversionException(sourceType, value, File.class);
	}
