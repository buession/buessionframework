...
public enum DomainTLD {
    ...
    AC("ac", DomainTLDType.COUNTRY, "Network Information Center (AC Domain Registry)c/o Cable and Wireless " + "" +
            "" + "(Ascension" + " Island)"),
    ...
    BB("bb", DomainTLDType.COUNTRY, "Government of BarbadosMinistry of Economic Affairs and " +
            "DevelopmentTelecommunications Unit"),
    ...
    BJ("bj", DomainTLDType.COUNTRY, "AutoritÃ© de RÃ©gulation des Communications Electroniques et de la Poste du " +
            "BÃ©nin (ARCEP BENIN)"),
    ...
    CATHOLIC("catholic", DomainTLDType.GENERIC, "Pontificium Consilium de Comunicationibus Socialibus (PCCS) " + "" +
    ...
    LA("la", DomainTLDType.COUNTRY, "Lao National Internet Committee (LANIC), Ministry of Posts and " +
            "Telecommunications"),
    ...
    LAT("lat", DomainTLDType.GENERIC, "ECOM-LAC FederaciÃ³n de LatinoamÃ©rica y el Caribe para Internet y el " +
    ...
    NYC("nyc", DomainTLDType.GENERIC, "The City of New York by and through the New York City Department of " +
    ...
    PS("ps", DomainTLDType.COUNTRY, "Ministry Of Telecommunications &Information Technology,Government Computer " +
            "Center."),
    ...
    TATAR("tatar", DomainTLDType.GENERIC, "Limited Liability Company \"Coordination Center of Regional Domain of " +
            "Tatarstan Republic\""),
    ...
    TD("td", DomainTLDType.COUNTRY, "l'Agence de DÃ©veloppement des Technologies de l'Information et de la " +
    ...
    UZ("uz", DomainTLDType.COUNTRY, "Single Integrator for Creation and Support of State Information Systems " +
            "UZINFOCOM"),
    ...
    测试("测试", DomainTLDType.TEST, " Internet Assigned Numbers Authority"),

    佛山("佛山", DomainTLDType.GENERIC, "Guangzhou YU Wei Information Technology Co., Ltd."),

    慈善("慈善", DomainTLDType.GENERIC, "Excellent First Limited"),

    集团("集团", DomainTLDType.GENERIC, "Eagle Horizon Limited"),

    在线("在线", DomainTLDType.GENERIC, "TLD REGISTRY LIMITED"),

    大众汽车("大众汽车", DomainTLDType.GENERIC, "Volkswagen (China) Investment Co., Ltd."),

    点看("点看", DomainTLDType.GENERIC, "VeriSign Sarl"),

    八卦("八卦", DomainTLDType.GENERIC, "Zodiac Gemini Ltd"),

    公益("公益", DomainTLDType.GENERIC, "Zodiac Gemini Ltd"),

    公司("公司", DomainTLDType.GENERIC, "Computer Network Information Center of Chinese Academy of Sciences （China " +
            "Internet Network Information Center"),

    香格里拉("香格里拉", DomainTLDType.GENERIC, "Shangri‐La International Hotel Management Limited"),

    网站("网站", DomainTLDType.GENERIC, "Global Website TLD Asia Limited"),

    移动("移动", DomainTLDType.GENERIC, "Afilias Limited"),

    我爱你("我爱你", DomainTLDType.GENERIC, "Tycoon Treasure Limited"),

    联通("联通", DomainTLDType.GENERIC, "China United Network Communications Corporation Limited"),

    时尚("时尚", DomainTLDType.GENERIC, "RISE VICTORY LIMITED"),

    微博("微博", DomainTLDType.GENERIC, "Sina Corporation"),

    淡马锡("淡马锡", DomainTLDType.GENERIC, "Temasek Holdings (Private) Limited"),

    商标("商标", DomainTLDType.GENERIC, "HU YI GLOBAL INFORMATION RESOURCES(HOLDING) COMPANY.HONGKONG LIMITED"),

    商店("商店", DomainTLDType.GENERIC, "Binky Moon, LLC"),

    商城("商城", DomainTLDType.GENERIC, "Zodiac Aquarius Limited"),

    新闻("新闻", DomainTLDType.GENERIC, "Guangzhou YU Wei Information and Technology Co.,Ltd"),

    工行("工行", DomainTLDType.GENERIC, "Industrial and Commercial Bank of China Limited"),

    家電("家電", DomainTLDType.GENERIC, "Amazon Registry Services, Inc."),

    中文网("中文网", DomainTLDType.GENERIC, "TLD REGISTRY LIMITED"),

    中信("中信", DomainTLDType.GENERIC, "CITIC Group Corporation"),

    中国("中国", DomainTLDType.COUNTRY, "China Internet Network Information Center (CNNIC)"),

    中國("中國", DomainTLDType.COUNTRY, "China Internet Network Information Center (CNNIC)"),

    娱乐("娱乐", DomainTLDType.GENERIC, "Binky Moon, LLC"),

    谷歌("谷歌", DomainTLDType.GENERIC, "Charleston Road Registry Inc."),

    電訊盈科("電訊盈科", DomainTLDType.GENERIC, "PCCW Enterprises Limited"),

    购物("购物", DomainTLDType.GENERIC, "Minds + Machines Group Limited"),

    測試("測試", DomainTLDType.TEST, "Internet Assigned Numbers Authority"),

    通販("通販", DomainTLDType.GENERIC, "Amazon Registry Services, Inc."),

    网店("网店", DomainTLDType.GENERIC, "Zodiac Taurus Ltd."),

    餐厅("餐厅", DomainTLDType.GENERIC, "HU YI GLOBAL INFORMATION RESOURCES (HOLDING) COMPANY. HONGKONG LIMITED"),

    网络("网络", DomainTLDType.GENERIC, "Computer Network Information Center of Chinese Academy of Sciences （China " +
            "Internet Network Information Center）"),

    香港("香港", DomainTLDType.COUNTRY, "Hong Kong Internet Registration Corporation Ltd."),

    诺基亚("诺基亚", DomainTLDType.GENERIC, "Nokia Corporation"),

    食品("食品", DomainTLDType.GENERIC, "Amazon Registry Services, Inc."),

    飞利浦("飞利浦", DomainTLDType.GENERIC, "Koninklijke Philips N.V."),

    台湾("台湾", DomainTLDType.COUNTRY, "Taiwan Network Information Center (TWNIC)"),

    台灣("台灣", DomainTLDType.COUNTRY, "Taiwan Network Information Center (TWNIC)"),

    手表("手表", DomainTLDType.GENERIC, "Richemont DNS Inc."),

    手机("手机", DomainTLDType.GENERIC, "Beijing RITT-Net Technology Development Co., Ltd"),

    澳門("澳門", DomainTLDType.GENERIC, "Macao Post and Telecommunications Bureau (CTT)"),

    政府("政府", DomainTLDType.GENERIC, "Net-Chinese Co., Ltd."),

    机构("机构", DomainTLDType.GENERIC, "Public Interest Registry"),

    组织机构("组织机构", DomainTLDType.GENERIC, "Public Interest Registry"),

    健康("健康", DomainTLDType.GENERIC, "Stable Tone Limited"),

    招聘("招聘", DomainTLDType.GENERIC, "Dot Trademark TLD Holding Company Limited"),

    珠宝("珠宝", DomainTLDType.GENERIC, "Richemont DNS Inc."),

    大拿("大拿", DomainTLDType.GENERIC, "VeriSign Sarl"),

    世界("世界", DomainTLDType.GENERIC, "Stable Tone Limited"),

    書籍("書籍", DomainTLDType.GENERIC, "Amazon Registry Services, Inc."),

    网址("网址", DomainTLDType.GENERIC, "KNET Co., Ltd"),

    天主教("天主教", DomainTLDType.GENERIC, "Pontificium Consilium de Comunicationibus Socialibus (PCCS) (Pontifical " +
            "Council for Social Communication)"),

    游戏("游戏", DomainTLDType.GENERIC, "Binky Moon, LLC"),

    企业("企业", DomainTLDType.GENERIC, "Binky Moon, LLC"),

    信息("信息", DomainTLDType.GENERIC, "Beijing Tele-info Network Technology Co., Ltd."),

    嘉里大酒店("嘉里大酒店", DomainTLDType.GENERIC, "Kerry Trading Co. Limited"),

    嘉里("嘉里", DomainTLDType.GENERIC, "Kerry Trading Co. Limited"),

    广东("广东", DomainTLDType.GENERIC, "Guangzhou YU Wei Information Technology Co., Ltd."),

    新加坡("新加坡", DomainTLDType.COUNTRY, "Singapore Network Information Centre (SGNIC) Pte Ltd"),

    政务("政务", DomainTLDType.GENERIC, "China Organizational Name Administration Center"),
    ...
    DomainTLD(String name, DomainTLDType type, String description){
        this.name = name;
        this.type = type;
