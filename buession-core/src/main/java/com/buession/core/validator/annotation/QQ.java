...
import com.buession.core.validator.constraintvalidators.QQConstraintValidator;
...
@Documented
@Constraint(validatedBy = {QQConstraintValidator.class})
@Repeatable(QQ.List.class)
public @interface QQ {

	String message() default "{buession.validation.constraints.QQ.message}";
