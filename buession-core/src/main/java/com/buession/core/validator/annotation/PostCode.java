...
import com.buession.core.validator.constraintvalidators.PostCodeConstraintValidator;
...
@Repeatable(PostCode.List.class)
public @interface PostCode {

	String message() default "{buession.validation.constraints.PostCode.message}";
