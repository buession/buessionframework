...
public class Validate {
     ...
     * @return 在两个值之间时，返回 TRUE；否则，返回 FALSE
     */
    public final static boolean isBetween(final float value, final float min, final float max, final boolean isContain){
        return isContain ? (value >= min && value <= max) : (value > min && value < max);
    }
     ...
     * @return Boolean
     */
    public final static boolean isIsbn10(final String charSequence, final char separator){
