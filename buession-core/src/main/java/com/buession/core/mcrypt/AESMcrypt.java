...
public final class AESMcrypt extends AbstractMcrypt {
    ...
    public String encode(final Object object){
        ...
        logger.debug("AESMcrypt encode string <{}> by algo <AES>, salt <{}>", object, getSalt());
    ...
    public String decode(final CharSequence cs){
        ...
        logger.debug("AESMcrypt decode string <{}> by algo <AES>, salt <{}>", cs, getSalt());
    ...
    private final SecretKeyFactory getSecretKeyFactory() throws NoSuchAlgorithmException{
        ...
        return provider == null ? SecretKeyFactory.getInstance(Algo.AES.getName()) : SecretKeyFactory.getInstance
                (Algo.AES.getName(), provider);
    }
    ...
    private final byte[] encode(final Key key, final byte[] data){
        Assert.isNull(data, "AESMcrypt decode object could not be null.");
