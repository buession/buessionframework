...
public final class DiscuzMycrypt extends AbstractMcrypt {
    ...
    public String encode(final Object object){
        if(object == null){
            throw new IllegalArgumentException("AbstractMcrypt encode object could not be null");
        }

        String s = object2String(object);

        String key = md5(md5(getKey()));
    ...
    public String decode(final CharSequence cs){
        if(cs == null){
            throw new IllegalArgumentException("AbstractMcrypt decode object could not be null");
        }
