...
public final class DESMcrypt extends AbstractMcrypt {
    ...
    public String encode(final Object object){
        if(object == null){
            throw new IllegalArgumentException("DESMcrypt encode object could not be null");
        }
    ...
    public String decode(final CharSequence cs){
        if(cs == null){
            throw new IllegalArgumentException("DESMcrypt decode object could not be null");
        }
    ...
    private final static Cipher initCipher(){
        if(cipher == null){
            try{
                cipher = Cipher.getInstance(Algo.DES.getName());
            }catch(NoSuchAlgorithmException e){
                logger.error(e.getMessage());
