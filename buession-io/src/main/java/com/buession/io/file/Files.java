...
public class Files {
     ...
     * @return 文件权限表示
     */
    public final static String mode2perms(final int mode){
    ...
    private final static char getFilePerm(final int mode, final int factor, final FilePermission defaultValue){
        return getFilePerm(mode, factor, defaultValue, FilePermission.NONE);
    }

    private final static char getFilePerm(final int mode, final int factor, final FilePermission t, final
    FilePermission f){
