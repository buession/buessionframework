...
public interface ClusterOperations extends ClusterCommands, RedisOperations {
	...
	@Override
	default Status clusterAddSlotsRange(final SlotRange... slots) {
	...
	@Override
	default Long clusterCountFailureReports(final String nodeId) {
		return execute((client)->client.clusterOperations().clusterCountFailureReports(nodeId));
	}

	@Override
	default Long clusterCountFailureReports(final byte[] nodeId) {
		return execute((client)->client.clusterOperations().clusterCountFailureReports(nodeId));
	}
	...
	@Override
	default Status clusterDelSlotsRange(final SlotRange... slots) {
	...
	@Override
	default List<ClusterRedisShard> clusterShards() {
