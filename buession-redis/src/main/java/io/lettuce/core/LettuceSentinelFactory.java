 ...
 * @since 3.0.0
 */
public class LettuceSentinelFactory extends AbstractLettuceFactory<StatefulRedisSentinelConnection<byte[], byte[]>> {

	public LettuceSentinelFactory(final String masterName, final Set<HostAndPort> sentinels) {
		super(buildRedisURI(masterName, sentinels, DefaultLettuceClientConfig.builder().build()));
	}

	public LettuceSentinelFactory(final String masterName, final Set<HostAndPort> sentinels,
								  final LettuceClientConfig lettuceClientConfig) {
		super(buildRedisURI(masterName, sentinels, lettuceClientConfig));
	}
