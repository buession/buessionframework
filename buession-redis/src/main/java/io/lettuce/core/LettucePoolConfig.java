 ...
 * @since 2.4.0
 */
public class LettucePool<K, V> extends Pool<StatefulRedisConnection<K, V>> {
	 ...
	 */
	public LettucePool(final String url, final SSLSocketFactory sslSocketFactory,
					   final SSLParameters sslParameters, final HostnameVerifier hostnameVerifier) {
		this(new GenericObjectPoolConfig<StatefulRedisConnection<K, V>>(),
	 ...
	 * 		线程池对象工厂
	 */
	public LettucePool(final PooledObjectFactory<StatefulRedisConnection<K, V>> factory) {
		super(factory);
	}
	 ...
	 * 		连接地址
	 */
	public LettucePool(final GenericObjectPoolConfig<StatefulRedisConnection<K, V>> poolConfig, final String url) {
	 ...
	 * 		Redis 端口
	 */
	public LettucePool(final GenericObjectPoolConfig<StatefulRedisConnection<K, V>> poolConfig, final String host,
					   final int port) {
	 ...
	 */
	public LettucePool(final GenericObjectPoolConfig<StatefulRedisConnection<K, V>> poolConfig, final String host,
					   final int port, final int timeout, final String password, final boolean ssl) {
	 ...
	 */
	public LettucePool(final GenericObjectPoolConfig<StatefulRedisConnection<K, V>> poolConfig, final String host,
					   final int port, final int timeout, final String user, final String password) {
	...
	public LettucePool(final URI uri) {
		this(new GenericObjectPoolConfig<StatefulRedisConnection<K, V>>(), uri);
	}
	 ...
	 *        {@link HostnameVerifier}
	 */
	public LettucePool(final URI uri, final SSLSocketFactory sslSocketFactory,
					   final SSLParameters sslParameters, final HostnameVerifier hostnameVerifier) {
	 ...
	 * 		连接 URL
	 */
	public LettucePool(final GenericObjectPoolConfig<StatefulRedisConnection<K, V>> poolConfig, final URI uri) {
	 ...
	 */
	public LettucePool(final GenericObjectPoolConfig<StatefulRedisConnection<K, V>> poolConfig,
					   final PooledObjectFactory<StatefulRedisConnection<K, V>> factory) {
