...
public class BaseRedisTemplate extends AbstractRedisTemplate {
	...
	public Status migrate(final String key, final String host, final int port, final int db, final int timeout,
	 final MigrateOperation migrateOperation){
		return execute((client)->client.migrate(makeRawKey(key), host, port, db, timeout, migrateOperation));
	}

	@Override
	public Status migrate(final byte[] key, final String host, final int port, final int db, final int timeout,
	 final MigrateOperation migrateOperation){
		return execute((client)->client.migrate(makeByteKey(key), host, port, db, timeout, migrateOperation));
	}
	...
	public Status set(final String key, final String value){
		return execute((client)->client.set(makeRawKey(key), value));
	}

	@Override
	public Status set(final byte[] key, final byte[] value){
		return execute((client)->client.set(makeByteKey(key), value));
	}

	@Override
	public Status set(final String key, final String value, final SetArgument setArgument){
		return execute((client)->client.set(makeRawKey(key), value, setArgument));
	}

	@Override
	public Status set(final byte[] key, final byte[] value, final SetArgument setArgument){
		return execute((client)->client.set(makeByteKey(key), value, setArgument));
	}

	@Override
	public Status setEx(final String key, final String value, final int lifetime){
		return execute((client)->client.setEx(makeRawKey(key), value, lifetime));
	}

	@Override
	public Status setEx(final byte[] key, final byte[] value, final int lifetime){
		return execute((client)->client.setEx(makeByteKey(key), value, lifetime));
	}

	@Override
	public Status pSetEx(final String key, final String value, final int lifetime){
		return execute((client)->client.pSetEx(makeRawKey(key), value, lifetime));
	}

	@Override
	public Status pSetEx(final byte[] key, final byte[] value, final int lifetime){
		return execute((client)->client.pSetEx(makeByteKey(key), value, lifetime));
	}

	@Override
	public Status setNx(final String key, final String value){
		return execute((client)->client.setNx(makeRawKey(key), value));
	}

	@Override
	public Status setNx(final byte[] key, final byte[] value){
		return execute((client)->client.setNx(makeByteKey(key), value));
	}

	@Override
	public Long append(final String key, final String value){
		return execute((client)->client.append(makeRawKey(key), value));
	}

	@Override
	public Long append(final byte[] key, final byte[] value){
		return execute((client)->client.append(makeByteKey(key), value));
	}

	@Override
	public String get(final String key){
		return execute((client)->client.get(makeRawKey(key)));
	}

	@Override
	public byte[] get(final byte[] key){
		return execute((client)->client.get(makeByteKey(key)));
	}

	@Override
	public String getSet(final String key, final String value){
		return execute((client)->client.getSet(makeRawKey(key), value));
	}

	@Override
	public byte[] getSet(final byte[] key, final byte[] value){
		return execute((client)->client.getSet(makeByteKey(key), value));
	}

	@Override
	public Status mSet(final Map<String, String> values){
		return execute((client)->client.mSet(values));
	}

	@Override
	public Status mSetNx(final Map<String, String> values){
		return execute((client)->client.mSetNx(values));
	}

	@Override
	public List<String> mGet(final String... keys){
		return execute((client)->client.mGet(makeRawKeys(keys)));
	}

	@Override
	public List<byte[]> mGet(final byte[]... keys){
		return execute((client)->client.mGet(makeByteKeys(keys)));
	}

	@Override
	public Long incr(final String key){
		return execute((client)->client.incr(makeRawKey(key)));
	}

	@Override
	public Long incr(final byte[] key){
		return execute((client)->client.incr(makeByteKey(key)));
	}

	@Override
	public Long incrBy(final String key, final int value){
		return execute((client)->client.incrBy(makeRawKey(key), value));
	}

	@Override
	public Long incrBy(final byte[] key, final int value){
		return execute((client)->client.incrBy(makeByteKey(key), value));
	}
	...
	public Double incrByFloat(final String key, final float value){
		return execute((client)->client.incrByFloat(makeRawKey(key), value));
	}

	@Override
	public Double incrByFloat(final byte[] key, final float value){
		return execute((client)->client.incrByFloat(makeByteKey(key), value));
	}
	...
	public Long decr(final String key){
		return execute((client)->client.decr(makeRawKey(key)));
	}

	@Override
	public Long decr(final byte[] key){
		return execute((client)->client.decr(makeByteKey(key)));
	}

	@Override
	public Long decrBy(final String key, final int value){
		return execute((client)->client.decrBy(makeRawKey(key), value));
	}

	@Override
	public Long decrBy(final byte[] key, final int value){
		return execute((client)->client.decrBy(makeByteKey(key), value));
	}
	...
	public Long setRange(final String key, final int offset, final String value){
		return execute((client)->client.setRange(makeRawKey(key), offset, value));
	}

	@Override
	public Long setRange(final byte[] key, final int offset, final byte[] value){
		return execute((client)->client.setRange(makeByteKey(key), offset, value));
	}
	...
	public String getRange(final String key, final int start, final int end){
		return execute((client)->client.getRange(makeRawKey(key), start, end));
	}

	@Override
	public byte[] getRange(final byte[] key, final int start, final int end){
		return execute((client)->client.getRange(makeByteKey(key), start, end));
	}
	...
	public String substr(final String key, final int start, final int end){
		return execute((client)->client.substr(makeRawKey(key), start, end));
	}

	@Override
	public byte[] substr(final byte[] key, final int start, final int end){
		return execute((client)->client.substr(makeByteKey(key), start, end));
	}
	...
	public Long strlen(final String key){
		return execute((client)->client.strlen(makeRawKey(key)));
	}

	@Override
	public Long strlen(final byte[] key){
		return execute((client)->client.strlen(makeByteKey(key)));
	}
	...
	public Long hDecrBy(final String key, final String field, final int value){
		return execute((client)->client.hDecrBy(makeRawKey(key), field, value));
	}

	@Override
	public Long hDecrBy(final byte[] key, final byte[] field, final int value){
		return execute((client)->client.hDecrBy(makeByteKey(key), field, value));
	}
	...
	public Long lInsert(final String key, final String value, final ListPosition position, final String pivot){
		return execute((client)->client.lInsert(makeRawKey(key), value, position, pivot));
	}

	@Override
	public Long lInsert(final byte[] key, final byte[] value, final ListPosition position, final byte[] pivot){
		return execute((client)->client.lInsert(makeByteKey(key), value, position, pivot));
	}
	...
	public String rPoplPush(final String source, final String destKey){
		return execute((client)->client.rPoplPush(makeRawKey(source), makeRawKey(destKey)));
	}

	@Override
	public byte[] rPoplPush(final byte[] source, final byte[] destKey){
		return execute((client)->client.rPoplPush(makeByteKey(source), makeByteKey(destKey)));
	}
	...
	public Set<String> sDiff(final String... keys){
		return execute((client)->client.sDiff(makeRawKeys(keys)));
	}

	@Override
	public Set<byte[]> sDiff(final byte[]... keys){
		return execute((client)->client.sDiff(makeByteKeys(keys)));
	}
	...
	public Set<String> sUnion(final String... keys){
		return execute((client)->client.sUnion(makeRawKeys(keys)));
	}

	@Override
	public Set<byte[]> sUnion(final byte[]... keys){
		return execute((client)->client.sUnion(makeByteKeys(keys)));
	}
	...
	public Status sMove(final String source, final String destKey, final String member){
		return execute((client)->client.sMove(makeRawKey(source), makeRawKey(destKey), member));
	}

	@Override
	public Status sMove(final byte[] source, final byte[] destKey, final byte[] member){
		return execute((client)->client.sMove(makeByteKey(source), makeByteKey(destKey), member));
	}
	...
	public Double zScore(final String key, final String member){
		return execute((client)->client.zScore(makeRawKey(key), member));
	}

	@Override
	public Double zScore(final byte[] key, final byte[] member){
		return execute((client)->client.zScore(makeByteKey(key), member));
	}
	...
	public Set<String> zRange(final String key, final int start, final int end){
		return execute((client)->client.zRange(makeRawKey(key), start, end));
	}

	@Override
	public Set<byte[]> zRange(final byte[] key, final int start, final int end){
		return execute((client)->client.zRange(makeByteKey(key), start, end));
	}
	...
	public Set<Tuple> zRangeWithScores(final String key, final int start, final int end){
		return execute((client)->client.zRangeWithScores(makeRawKey(key), start, end));
	}

	@Override
	public Set<Tuple> zRangeWithScores(final byte[] key, final int start, final int end){
		return execute((client)->client.zRangeWithScores(makeByteKey(key), start, end));
	}
	...
	public Set<String> zRangeByScore(final String key, final float min, final float max){
		return execute((client)->client.zRangeByScore(makeRawKey(key), min, max));
	}

	@Override
	public Set<byte[]> zRangeByScore(final byte[] key, final float min, final float max){
		return execute((client)->client.zRangeByScore(makeByteKey(key), min, max));
	}
	...
	public Set<String> zRangeByLex(final String key, final float min, final float max){
		return execute((client)->client.zRangeByLex(makeRawKey(key), min, max));
	}

	@Override
	public Set<byte[]> zRangeByLex(final byte[] key, final float min, final float max){
		return execute((client)->client.zRangeByLex(makeByteKey(key), min, max));
	}
	...
	public Long zRank(final String key, final String member){
		return execute((client)->client.zRank(makeRawKey(key), member));
	}

	@Override
	public Long zRank(final byte[] key, final byte[] member){
		return execute((client)->client.zRank(makeByteKey(key), member));
	}

	@Override
	public Long zRevRank(final String key, final String member){
		return execute((client)->client.zRevRank(makeRawKey(key), member));
	}

	@Override
	public Long zRevRank(final byte[] key, final byte[] member){
		return execute((client)->client.zRevRank(makeByteKey(key), member));
	}

	@Override
	public Long zRem(final String key, final String... members){
		return execute((client)->client.zRem(makeRawKey(key), members));
	}

	@Override
	public Long zRem(final byte[] key, final byte[]... members){
		return execute((client)->client.zRem(makeByteKey(key), members));
	}

	@Override
	public Long zRemRangeByRank(final String key, final int start, final int end){
		return execute((client)->client.zRemRangeByRank(makeRawKey(key), start, end));
	}

	@Override
	public Long zRemRangeByRank(final byte[] key, final int start, final int end){
		return execute((client)->client.zRemRangeByRank(makeByteKey(key), start, end));
	}
	...
	public Long zRemRangeByScore(final String key, final float min, final float max){
		return execute((client)->client.zRemRangeByScore(makeRawKey(key), min, max));
	}

	@Override
	public Long zRemRangeByScore(final byte[] key, final float min, final float max){
		return execute((client)->client.zRemRangeByScore(makeByteKey(key), min, max));
	}
	...
	public Long zRemRangeByLex(final String key, final float min, final float max){
		return execute((client)->client.zRemRangeByLex(makeRawKey(key), min, max));
	}

	@Override
	public Long zRemRangeByLex(final byte[] key, final float min, final float max){
		return execute((client)->client.zRemRangeByLex(makeByteKey(key), min, max));
	}
	...
	public Set<String> zRevRange(final String key, final int start, final int end){
		return execute((client)->client.zRevRange(makeRawKey(key), start, end));
	}

	@Override
	public Set<byte[]> zRevRange(final byte[] key, final int start, final int end){
		return execute((client)->client.zRevRange(makeByteKey(key), start, end));
	}
	...
	public Set<Tuple> zRevRangeWithScores(final String key, final int start, final int end){
		return execute((client)->client.zRevRangeWithScores(makeRawKey(key), start, end));
	}

	@Override
	public Set<Tuple> zRevRangeWithScores(final byte[] key, final int start, final int end){
		return execute((client)->client.zRevRangeWithScores(makeByteKey(key), start, end));
	}
	...
	public Set<String> zRevRangeByScore(final String key, final float min, final float max){
		return execute((client)->client.zRevRangeByScore(makeRawKey(key), max, min));
	}

	@Override
	public Set<byte[]> zRevRangeByScore(final byte[] key, final float min, final float max){
		return execute((client)->client.zRevRangeByScore(makeByteKey(key), max, min));
	}
	...
	public Set<String> zRevRangeByScore(final String key, final float min, final float max, final int offset,
	 final int count){
		return execute((client)->client.zRevRangeByScore(makeRawKey(key), max, min, offset, count));
	}

	@Override
	public Set<byte[]> zRevRangeByScore(final byte[] key, final float min, final float max, final int offset,
	 final int count){
		return execute((client)->client.zRevRangeByScore(makeByteKey(key), max, min, offset, count));
	}
	...
	public Set<Tuple> zRevRangeByScoreWithScores(final String key, final float min, final float max){
		return execute((client)->client.zRevRangeByScoreWithScores(makeRawKey(key), max, min));
	}

	@Override
	public Set<Tuple> zRevRangeByScoreWithScores(final byte[] key, final float min, final float max){
		return execute((client)->client.zRevRangeByScoreWithScores(makeByteKey(key), max, min));
	}
	...
	public Set<Tuple> zRevRangeByScoreWithScores(final String key, final float max, final float min, final int offset,
	 final int count){
		return execute((client)->client.zRevRangeByScoreWithScores(makeRawKey(key), max, min, offset, count));
	}

	@Override
	public Set<Tuple> zRevRangeByScoreWithScores(final byte[] key, final float min, final float max, final int offset,
	 final int count){
		return execute((client)->client.zRevRangeByScoreWithScores(makeByteKey(key), max, min, offset, count));
	}
	...
	public Set<String> zRevRangeByLex(final String key, final float min, final float max){
		return execute((client)->client.zRevRangeByLex(makeRawKey(key), min, max));
	}

	@Override
	public Set<byte[]> zRevRangeByLex(final byte[] key, final float min, final float max){
		return execute((client)->client.zRevRangeByLex(makeByteKey(key), min, max));
	}
	...
	public Long zLexCount(final String key, final float min, final float max){
		return execute((client)->client.zLexCount(makeRawKey(key), min, max));
	}

	@Override
	public Long zLexCount(final byte[] key, final float min, final float max){
		return execute((client)->client.zLexCount(makeByteKey(key), min, max));
	}
	...
	@Override
	public Long zUnionStore(final byte[] destKey, final Aggregate aggregate, final double[] wights,
	 final byte[]... keys){
	...
	public ScanResult<List<Tuple>> zScan(final String key, final int cursor){
		return execute((client)->client.zScan(makeRawKey(key), cursor));
	}

	@Override
	public ScanResult<List<Tuple>> zScan(final byte[] key, final int cursor){
		return execute((client)->client.zScan(makeByteKey(key), cursor));
	}
	...
	public ScanResult<List<Tuple>> zScan(final String key, final int cursor, final String pattern){
		return execute((client)->client.zScan(makeRawKey(key), cursor, pattern));
	}

	@Override
	public ScanResult<List<Tuple>> zScan(final byte[] key, final int cursor, final byte[] pattern){
		return execute((client)->client.zScan(makeByteKey(key), cursor, pattern));
	}
	...
	public ScanResult<List<Tuple>> zScan(final String key, final int cursor, final int count){
		return execute((client)->client.zScan(makeRawKey(key), cursor, count));
	}

	@Override
	public ScanResult<List<Tuple>> zScan(final byte[] key, final int cursor, final int count){
		return execute((client)->client.zScan(makeByteKey(key), cursor, count));
	}
	...
	public ScanResult<List<Tuple>> zScan(final String key, final int cursor, final String pattern, final int count){
		return execute((client)->client.zScan(makeRawKey(key), cursor, pattern, count));
	}

	@Override
	public ScanResult<List<Tuple>> zScan(final byte[] key, final int cursor, final byte[] pattern, final int count){
		return execute((client)->client.zScan(makeByteKey(key), cursor, pattern, count));
	}
	...
	public Long geoAdd(final String key, final String member, final Geo geo){
		return execute((client)->client.geoAdd(makeRawKey(key), member, geo));
	}

	@Override
	public Long geoAdd(final byte[] key, final byte[] member, final Geo geo){
		return execute((client)->client.geoAdd(makeByteKey(key), member, geo));
	}
	...
	public List<GeoRadius> geoRadius(final String key, final Geo geo, final double radius){
		return execute((client)->client.geoRadius(makeRawKey(key), geo, radius));
	}

	@Override
	public List<GeoRadius> geoRadius(final byte[] key, final Geo geo, final double radius){
		return execute((client)->client.geoRadius(makeByteKey(key), geo, radius));
	}
	...
	public List<GeoRadius> geoRadius(final String key, final Geo geo, final double radius, final GeoUnit unit){
		return execute((client)->client.geoRadius(makeRawKey(key), geo, radius, unit));
	}

	@Override
	public List<GeoRadius> geoRadius(final byte[] key, final Geo geo, final double radius, final GeoUnit unit){
		return execute((client)->client.geoRadius(makeByteKey(key), geo, radius, unit));
	}
	...
	public List<GeoRadius> geoRadius(final String key, final Geo geo, final double radius,
	 final GeoArgument geoArgument){
		return execute((client)->client.geoRadius(makeRawKey(key), geo, radius, geoArgument));
	}

	@Override
	public List<GeoRadius> geoRadius(final byte[] key, final Geo geo, final double radius,
	 final GeoArgument geoArgument){
		return execute((client)->client.geoRadius(makeByteKey(key), geo, radius, geoArgument));
	}
	...
	public List<GeoRadius> geoRadius(final String key, final Geo geo, final double radius, final GeoUnit unit,
	 final GeoArgument geoArgument){
		return execute((client)->client.geoRadius(makeRawKey(key), geo, radius, unit, geoArgument));
	}

	@Override
	public List<GeoRadius> geoRadius(final byte[] key, final Geo geo, final double radius, final GeoUnit unit,
	 final GeoArgument geoArgument){
		return execute((client)->client.geoRadius(makeByteKey(key), geo, radius, unit, geoArgument));
	}
	...
	public Status setBit(final String key, final long offset, final String value){
		return execute((client)->client.setBit(makeRawKey(key), offset, value));
	}

	@Override
	public Status setBit(final byte[] key, final long offset, final byte[] value){
		return execute((client)->client.setBit(makeByteKey(key), offset, value));
	}
	...
	public Status getBit(final String key, final long offset){
		return execute((client)->client.getBit(makeRawKey(key), offset));
	}

	@Override
	public Status getBit(final byte[] key, final long offset){
		return execute((client)->client.getBit(makeByteKey(key), offset));
	}

	@Override
	public Long bitPos(final String key, final boolean value){
		return execute((client)->client.bitPos(makeRawKey(key), value));
	}

	@Override
	public Long bitPos(final byte[] key, final boolean value){
		return execute((client)->client.bitPos(makeByteKey(key), value));
	}

	@Override
	public Long bitPos(final String key, final boolean value, final int start, final int end){
		return execute((client)->client.bitPos(makeRawKey(key), value, start, end));
	}

	@Override
	public Long bitPos(final byte[] key, final boolean value, final int start, final int end){
		return execute((client)->client.bitPos(makeByteKey(key), value, start, end));
	}
	...
	public List<Long> bitField(final String key, final String... arguments){
		return execute((client)->client.bitField(makeRawKey(key), arguments));
	}

	@Override
	public List<Long> bitField(final byte[] key, final byte[]... arguments){
		return execute((client)->client.bitField(makeByteKey(key), arguments));
	}

	@Override
	public Long bitCount(final String key){
		return execute((client)->client.bitCount(makeRawKey(key)));
	}

	@Override
	public Long bitCount(final byte[] key){
		return execute((client)->client.bitCount(makeByteKey(key)));
	}

	@Override
	public Long bitCount(final String key, final long start, final long end){
		return execute((client)->client.bitCount(makeRawKey(key), start, end));
	}

	@Override
	public Long bitCount(final byte[] key, final long start, final long end){
		return execute((client)->client.bitCount(makeByteKey(key), start, end));
	}
	...
	public Object eval(final String script, final String[] keys, final String[] args){
		return execute((client)->client.eval(script, keys, args));
	}
	...
	public Object evalSha(final String digest, final String[] keys, final String[] args){
		return execute((client)->client.evalSha(digest, keys, args));
	}
