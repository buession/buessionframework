...
public class Replication implements Serializable {
	...
	public final static class Master implements Serializable {
		 ...
		 */
		private MasterLinkStatus masterLinkStatus;
		 ...
		 * 		复制连接当前的状态
		 */
		public void setMasterLinkStatus(MasterLinkStatus masterLinkStatus){
			this.masterLinkStatus = masterLinkStatus;
		}
