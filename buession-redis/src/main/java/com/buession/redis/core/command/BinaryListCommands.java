 ...
 * @author Yong.Teng
 */
public interface BinaryListCommands extends BinaryRedisCommands {

	/**
	 * 将一个或多个值 value 插入到列表 key 的表头
	 *
	 * <p>详情说明 <a href="http://redisdoc.com/list/lpush.html" target="_blank">http://redisdoc.com/list/lpush.html</a>
	 * </p>
	 *
	 * @param key
	 * 		Key
	 ...
	 */
	Long lInsert(final byte[] key, final byte[] value, final ListCommands.ListPosition position, final byte[] pivot);
	 ...
	 *
	 * <p>详情说明 <a href="http://redisdoc.com/list/lindex.html" target="_blank">http://redisdoc.com/list/lindex.html</a>
	 * </p>
	 *
	 * @param key
	 * 		Key
	 ...
	 *
	 * <p>详情说明 <a href="http://redisdoc.com/list/blpop.html" target="_blank">http://redisdoc.com/list/blpop.html</a>
	 * </p>
	 *
	 * @param keys
	 * 		一个或多个 key
	 ...
	 * @return 被弹出的元素
	 */
	byte[] rPoplPush(final byte[] key, final byte[] destKey);

	/**
	 * 移除并返回列表中一个或多个 key 的尾元素，BRPOP 是列表的阻塞式(blocking)弹出原语；
	 * 当给定列表内没有任何元素可供弹出的时候，连接将被阻塞，直到等待超时或发现可弹出元素为止
	 *
	 * <p>详情说明 <a href="http://redisdoc.com/list/brpop.html" target="_blank">http://redisdoc.com/list/brpop.html</a>
	 * </p>
	 *
	 * @param keys
	 * 		一个或多个 key
	 ...
	 *
	 * <p>详情说明 <a href="http://redisdoc.com/list/rpush.html" target="_blank">http://redisdoc.com/list/rpush.html</a>
	 * </p>
	 *
	 * @param key
	 * 		Key
	 ...
	 *
	 * <p>详情说明 <a href="http://redisdoc.com/list/lrange.html" target="_blank">http://redisdoc.com/list/lrange.html</a>
	 * </p>
	 *
	 * @param key
	 * 		Key
