...
/**
 * {@link Map.Entry} 转换为 {@link XReadInfo}
 *
 * @param <SK>
 * 		原始 Key 类型
 * @param <TK>
 ...
 * @since 4.0.0
 */
public final class MapEntryStreamEntryXReadInfoConverter<SK, TK, TV>
		implements Converter<Map.Entry<SK, List<redis.clients.jedis.resps.StreamEntry>>, XReadInfo<TK, TV>> {
	...
	@Override
	public XReadInfo<TK, TV> convert(final Map.Entry<SK, List<redis.clients.jedis.resps.StreamEntry>> source) {
		if(source == null){
			return null;
		}
