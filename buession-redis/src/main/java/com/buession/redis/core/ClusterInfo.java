 ...
 * @since 2.0.0
 */
public record ClusterInfo(State state, int slotsAssigned, int slotsOk, int slotsPfail, int slotsFail, int knownNodes,
						  int size, int currentEpoch, int myEpoch, long messagesPingSent, long messagesPongSent,
						  long messagesSent, long messagesPingReceived, long messagesPongReceived,
						  long messagesMeetReceived, long messagesReceived) implements Serializable {
