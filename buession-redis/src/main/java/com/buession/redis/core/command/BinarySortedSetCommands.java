 ...
 * @author Yong.Teng
 */
public interface BinarySortedSetCommands extends BinaryRedisCommands {
	 ...
	 * @return 保存到 destKey 结果集的基数
	 */
	Long zInterStore(final byte[] destKey, final SortedSetCommands.Aggregate aggregate, final byte[]... keys);
	 ...
	 * @return 保存到 destKey 结果集的基数
	 */
	Long zInterStore(final byte[] destKey, final SortedSetCommands.Aggregate aggregate, final double[] weights,
					 final byte[]... keys);
	 ...
	 * @return 保存到 destKey 的结果集的基数
	 */
	Long zUnionStore(final byte[] destKey, final SortedSetCommands.Aggregate aggregate, final byte[]... keys);
	 ...
	 * @return 保存到 destKey 的结果集的基数
	 */
	Long zUnionStore(final byte[] destKey, final SortedSetCommands.Aggregate aggregate, final double[] weights,
					 final byte[]... keys);
