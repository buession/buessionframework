...
public interface KeyOperations extends KeyCommands, RedisOperations {
     ...
     * @return 操作结果
     */
    Status migrate(final String key, final String host, final int db, final int timeout, final MigrateOperation
            migrateOperation);
     ...
     * @return 操作结果
     */
    Status migrate(final byte[] key, final String host, final int db, final int timeout, final MigrateOperation
            migrateOperation);
