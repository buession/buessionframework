...
public interface SortedSetCommands extends RedisCommands {
	...
	/**
	 * 从一个或多个有序集合 (Sorted Set) 中，按照给定的顺序（最小分或最大分）弹出多个成员。如果所有指定的键都为空或不存，命令会阻塞连接，直到有数据可用或超时
	 *
	 * <p>详情说明 <a href="https://redis.io/docs/latest/commands/bzmpop/" target="_blank">https://redis.io/docs/latest/commands/bzmpop/</a></p>
	 *
	 * @param keys
	 * 		一个或多个 Key
	 * @param timeout
	 ...
	 */
	KeyValue<String, List<Tuple>> bzMPop(final String[] keys, final int timeout, final MinMax minMax);
	 ...
	 * @return 元素 key 名称，成员名称，元素分数
	 */
	KeyValue<byte[], List<Tuple>> bzMPop(final byte[][] keys, final int timeout, final MinMax minMax);
	 ...
	 * @return 元素 key 名称，成员名称，元素分数
	 */
	KeyValue<String, List<Tuple>> bzMPop(final String[] keys, final int timeout, final MinMax minMax, final int count);
	 ...
	 * @return 元素 key 名称，成员名称，元素分数
	 */
	KeyValue<byte[], List<Tuple>> bzMPop(final byte[][] keys, final int timeout, final MinMax minMax, final int count);
	 ...
	 */
	Long zAdd(final String key, final Tuple... members);
	 ...
	 * @return 被成功添加的新成员的数量，不包括那些被更新的、已经存在的成员
	 */
	Long zAdd(final byte[] key, final Tuple... members);
	 ...
	 * @return 被成功添加的新成员的数量，不包括那些被更新的、已经存在的成员
	 */
	Long zAdd(final String key, final Tuple[] members, final ZAddArgument argument);
	 ...
	 * @return 被成功添加的新成员的数量，不包括那些被更新的、已经存在的成员
	 */
	Long zAdd(final byte[] key, final Tuple[] members, final ZAddArgument argument);
	...
	/**
	 * 统计同时存在于所有给定有序集合中的成员数量
	 *
	 * <p>详情说明 <a href="https://redis.io/docs/latest/commands/zintercard/" target="_blank">https://redis.io/docs/latest/commands/zintercard/</a></p>
	 *
	 * @param keys
	 * 		一个或多个 Key
	 *
	 * @return 交集的元素数量
	 */
	long zInterCard(final String... keys);
	 ...
	 * @return 交集的元素数量
	 */
	long zInterCard(final byte[]... keys);
	 ...
	 * @return 交集的元素数量
	 */
	long zInterCard(final String[] keys, final int limit);
	 ...
	 * @return 交集的元素数量
	 */
	long zInterCard(final byte[][] keys, final int limit);
	...
	/**
	 * 从一个或多个有序集合（Sorted Set）中，按照指定的顺序（最小分或最大分），一次性弹出多个成员
	 *
	 * <p>详情说明 <a href="https://redis.io/docs/latest/commands/zmpop/" target="_blank">https://redis.io/docs/latest/commands/zmpop/</a></p>
	 *
	 * @param keys
	 * 		一个或多个 Key
	 * @param minMax
	 ...
	 * @return 元素 key 名称，成员名称，元素分数
	 */
	KeyValue<String, List<Tuple>> zMPop(final String[] keys, final MinMax minMax);
	 ...
	 * @return 元素 key 名称，成员名称，元素分数
	 */
	KeyValue<byte[], List<Tuple>> zMPop(final byte[][] keys, final MinMax minMax);
	 ...
	 * @return 元素 key 名称，成员名称，元素分数
	 */
	KeyValue<String, List<Tuple>> zMPop(final String[] keys, final MinMax minMax, final int count);
	 ...
	 * @return 元素 key 名称，成员名称，元素分数
	 */
	KeyValue<byte[], List<Tuple>> zMPop(final byte[][] keys, final MinMax minMax, final int count);
	 ...
	 * @return 弹出的元素和分数列表
	 */
	List<Tuple> zPopMax(final String key, final int count);
	 ...
	 * @return 弹出的元素和分数列表
	 */
	List<Tuple> zPopMax(final byte[] key, final int count);
	 ...
	 * @return 弹出的元素和分数列表
	 */
	List<Tuple> zPopMin(final String key, final int count);
	 ...
	 * @return 弹出的元素和分数列表
	 */
	List<Tuple> zPopMin(final byte[] key, final int count);
	 ...
	 */
	List<String> zRandMember(final String key, final int count);
	 ...
	 * @return 有序集合 key 中的随机元素
	 */
	List<byte[]> zRandMember(final byte[] key, final int count);
	 ...
	 * @return 有序集合 key 中的随机元素
	 */
	Tuple zRandMemberWithScores(final String key);
	 ...
	 * @return 有序集合 key 中的随机元素
	 */
	Tuple zRandMemberWithScores(final byte[] key);
	 ...
	 * @return 有序集合 key 中的随机元素
	 */
	List<Tuple> zRandMemberWithScores(final String key, final int count);
	 ...
	 * @return 有序集合 key 中的随机元素
	 */
	List<Tuple> zRandMemberWithScores(final byte[] key, final int count);
	 ...
	 * 当 end 参数的值比有序集的最大下标还要大时，最多返回到 end
	 */
	List<String> zRange(final String key, final long start, final long end, final int offset, final int count);
	 ...
	 * 当 end 参数的值比有序集的最大下标还要大时，最多返回到 end
	 */
	List<byte[]> zRange(final byte[] key, final long start, final long end, final int offset, final int count);
	 ...
	 * 当 end 参数的值比有序集的最大下标还要大时，最多返回到 end
	 */
	List<Tuple> zRangeWithScores(final String key, final long start, final long end, final int offset, final int count);
	 ...
	 * 当 end 参数的值比有序集的最大下标还要大时，最多返回到 end
	 */
	List<Tuple> zRangeWithScores(final byte[] key, final long start, final long end, final int offset, final int count);
	 ...
	 */
	List<String> zRangeByLex(final String key, final double min, final double max, final int offset, final int count);
	 ...
	 * @return 包含了有序集合在指定范围内从 offset 开始的 count 个成员的列表
	 */
	List<byte[]> zRangeByLex(final byte[] key, final double min, final double max, final int offset, final int count);
	 ...
	 */
	List<String> zRangeByScore(final String key, final double min, final double max, final int offset, final int count);
	 ...
	 * @return 指定区间内从 offset 开是的 count 个，有序集成员的列表
	 */
	List<byte[]> zRangeByScore(final byte[] key, final double min, final double max, final int offset, final int count);
	 ...
	 */
	List<Tuple> zRangeByScoreWithScores(final String key, final double min, final double max, final int offset,
										final int count);
	 ...
	 * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
	 */
	List<Tuple> zRangeByScoreWithScores(final byte[] key, final double min, final double max, final int offset,
										final int count);
	 ...
	 * @return The number of elements in the resulting sorted set
	 */
	Long zRangeStore(final String destKey, final String key, final long start, final long end, final int offset,
					 final int count);
	 ...
	 * @return The number of elements in the resulting sorted set
	 */
	Long zRangeStore(final byte[] destKey, final byte[] key, final long start, final long end, final int offset,
					 final int count);
	 ...
	 *
	 * <p>详情说明 <a href="https://redis.io/docs/latest/commands/zrank/" target="_blank">https://redis.io/docs/latest/commands/zrank/</a></p>
	 *
	 * @param key
	 * 		Key
	 * @param member
	 ...
	 * @return 包含了有序集合在指定范围内的成员列表
	 */
	List<String> zRevRangeByLex(final String key, final double min, final double max, final int offset,
								final int count);
	 ...
	 * @return 包含了有序集合在指定范围内的成员列表
	 */
	List<byte[]> zRevRangeByLex(final byte[] key, final double min, final double max, final int offset,
								final int count);
	 ...
	 * @return 指定区间内，有序集成员的列表
	 */
	List<String> zRevRangeByScore(final String key, final double min, final double max, final int offset,
								  final int count);
	 ...
	 * @return 指定区间内，有序集成员的列表
	 */
	List<byte[]> zRevRangeByScore(final byte[] key, final double min, final double max, final int offset,
								  final int count);
	 ...
	 * @return 指定区间内，有序集成员的列表
	 */
	List<Tuple> zRevRangeByScoreWithScores(final String key, final double min, final double max, final int offset,
										   final int count);
	 ...
	 * @return 指定区间内，有序集成员的列表
	 */
	List<Tuple> zRevRangeByScoreWithScores(final byte[] key, final double min, final double max, final int offset,
										   final int count);

	/**
	 * 获取有序集 key 中成员 member 的排名。其中有序集成员按 score 值递减（从大到小）排序
	 *
	 * <p>详情说明 <a href="https://redis.io/docs/latest/commands/zrevrank/" target="_blank">https://redis.io/docs/latest/commands/zrevrank/</a></p>
	 *
	 * @param key
	 * 		Key
	 * @param member
	 ...
	 */
	ScanResult<Tuple> zScan(final String key, final String cursor, final String pattern);
	 ...
	 * @return 返回和给定模式相匹配的元素
	 */
	ScanResult<Tuple> zScan(final byte[] key, final byte[] cursor, final byte[] pattern);
	 ...
	 * @return 返回的指定数量的键值对
	 */
	ScanResult<Tuple> zScan(final String key, final String cursor, final int count);
	 ...
	 * @return 返回的指定数量的键值对
	 */
	ScanResult<Tuple> zScan(final byte[] key, final byte[] cursor, final int count);
	 ...
	 */
	ScanResult<Tuple> zScan(final String key, final String cursor, final String pattern, final int count);
	 ...
	 * @return 返回和给定模式相匹配指定数量的元素
	 */
	ScanResult<Tuple> zScan(final byte[] key, final byte[] cursor, final byte[] pattern, final int count);
