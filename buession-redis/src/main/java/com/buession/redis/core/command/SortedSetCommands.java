...
public interface SortedSetCommands extends RedisCommands {
     ...
     * @return 被成功添加的新成员的数量，不包括那些被更新的、已经存在的成员
     */
    Long zAdd(final String key, final List<KeyValue<String, Number>> members);
     ...
     * @return 被成功添加的新成员的数量，不包括那些被更新的、已经存在的成员
     */
    Long zAdd(final byte[] key, final List<KeyValue<byte[], Number>> members);

    /**
     * 获取有序集 key 中，成员 member 的 score 值
     *
     * <p>详情说明 <a href="http://redisdoc.com/sorted_set/zscore.html" target="_blank">http://redisdoc
     * .com/sorted_set/zscore.html</a></p>
     *
     * @param key
     *         Key
     * @param member
     ...
     */
    Set<Tuple> zRangeByScoreWithScores(final String key, final float min, final float max, final int offset, final
    int count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final byte[] key, final float min, final float max, final int offset, final
    int count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final String key, final double min, final double max, final int offset, final
    int count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final byte[] key, final double min, final double max, final int offset, final
    int count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final String key, final int min, final int max, final int offset, final int
            count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final byte[] key, final int min, final int max, final int offset, final int
            count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final String key, final long min, final long max, final int offset, final int
            count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final byte[] key, final long min, final long max, final int offset, final int
            count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final String key, final String min, final String max, final int offset, final
    int count);
     ...
     * @return 指定区间内带有 score 的从 offset 开是的 count 个，有序集成员的列表
     */
    Set<Tuple> zRangeByScoreWithScores(final byte[] key, final byte[] min, final byte[] max, final int offset, final
    int count);
     ...
     *
     * <p>详情说明 <a href="http://redisdoc.com/sorted_set/zrem.html" target="_blank">http://redisdoc
     * .com/sorted_set/zrem.html</a></p>
     *
     * @param key
     *         Key
     * @param members
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<String> zRevRangeByScore(final String key, final float min, final float max, final int offset, final int count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<byte[]> zRevRangeByScore(final byte[] key, final float min, final float max, final int offset, final int count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<String> zRevRangeByScore(final String key, final double min, final double max, final int offset, final int
            count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<byte[]> zRevRangeByScore(final byte[] key, final double min, final double max, final int offset, final int
            count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<String> zRevRangeByScore(final String key, final String min, final String max, final int offset, final int
            count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<byte[]> zRevRangeByScore(final byte[] key, final byte[] min, final byte[] max, final int offset, final int
            count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<Tuple> zRevRangeByScoreWithScores(final String key, final float min, final float max, final int offset, final
    int count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<Tuple> zRevRangeByScoreWithScores(final byte[] key, final float min, final float max, final int offset, final
    int count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<Tuple> zRevRangeByScoreWithScores(final String key, final int min, final int max, final int offset, final int
            count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<Tuple> zRevRangeByScoreWithScores(final byte[] key, final int min, final int max, final int offset, final int
            count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<Tuple> zRevRangeByScoreWithScores(final String key, final long min, final long max, final int offset, final
    int count);
     ...
     * @return 指定区间内，有序集成员的列表
     */
    Set<Tuple> zRevRangeByScoreWithScores(final byte[] key, final long min, final long max, final int offset, final
    int count);
     ...
     * @return 包含了有序集合在指定范围内的成员列表
     */
    Set<String> zRevRangeByLex(final String key, final double min, final double max, final int offset, final int count);
     ...
     * @return 包含了有序集合在指定范围内的成员列表
     */
    Set<byte[]> zRevRangeByLex(final byte[] key, final double min, final double max, final int offset, final int count);
     ...
     * @return 包含了有序集合在指定范围内的成员列表
     */
    Set<String> zRevRangeByLex(final String key, final String min, final String max, final int offset, final int count);
     ...
     * @return 包含了有序集合在指定范围内的成员列表
     */
    Set<byte[]> zRevRangeByLex(final byte[] key, final byte[] min, final byte[] max, final int offset, final int count);
