...
/**
 * Jedis {@link TSMGetElement} 转换为 {@link TimeSeriesMGetElement}
 *
 * @author Yong.Teng
 * @since 4.0.0
 */
public final class TSMGetElementConveter implements Converter<TSMGetElement, TimeSeriesMGetElement> {

	@Override
	public TimeSeriesMGetElement convert(final TSMGetElement source) {
		if(source == null){
			return null;
		}
