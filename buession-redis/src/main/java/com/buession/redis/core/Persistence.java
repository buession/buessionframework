...
public class Persistence implements Serializable {
	...
	/**
	 * 最后一次执行 AOF 重写操作期间 copy-on-write 分配的字节大小
	 */
	...
	/**
	 * 设置最后一次执行 rdb 操作期间 copy-on-write 分配的字节大小
	 *
	 * @param rdbLastCowSize
	 * 		最后一次执行 rdb 操作期间 copy-on-write 分配的字节大小
	 */
	...
	/**
	 * 设置最后一次执行 AOF 重写操作期间 copy-on-write 分配的字节大小
	 *
	 * @param aofLastCowSize
	 * 		最后一次执行 AOF 重写操作期间 copy-on-write 分配的字节大小
	 */
