...
public class SugGetArgument {
	...
	public SugGetArgument() {
	}

	public SugGetArgument(final boolean fuzzy, final boolean withScores, final boolean withPayloads, final long max) {
		this.fuzzy = fuzzy;
	...
	public SugGetArgument(final long max) {
		this.max = max;
	}
	...
	public SugGetArgument fuzzy() {
		return setFuzzy(true);
	}

	public SugGetArgument setFuzzy(boolean fuzzy) {
		this.fuzzy = fuzzy;
		return this;
	}
	...
	public SugGetArgument withScores() {
		return setWithScores(true);
	}

	public SugGetArgument setWithScores(Boolean withScores) {
		this.withScores = withScores;
		return this;
	}
	...
	public SugGetArgument withPayloads() {
		return setWithPayloads(true);
	}

	public SugGetArgument setWithPayloads(Boolean withPayloads) {
		this.withPayloads = withPayloads;
		return this;
	}
	...
	public SugGetArgument setMax(long max) {
		this.max = max;
		return this;
	}
