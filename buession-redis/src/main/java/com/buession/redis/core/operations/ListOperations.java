...
public interface ListOperations extends ListCommands, RedisOperations {
	 ...
	 */
	<V> V lIndexObject(final String key, final int index);
	 ...
	 * @return 下标为 index 的元素反序列化后的值；如果 index 参数的值不在列表的区间范围内，返回 null
	 */
	<V> V lIndexObject(final byte[] key, final int index);
	 ...
	 * @see java.lang.Class
	 */
	<V> V lIndexObject(final String key, final int index, final Class<V> clazz);
	 ...
	 * @see java.lang.Class
	 */
	<V> V lIndexObject(final byte[] key, final int index, final Class<V> clazz);
	 ...
	 * @see com.buession.core.serializer.type.TypeReference
	 */
	<V> V lIndexObject(final String key, final int index, final TypeReference<V> type);
	 ...
	 * @see com.buession.core.serializer.type.TypeReference
	 */
	<V> V lIndexObject(final byte[] key, final int index, final TypeReference<V> type);
	 ...
	 */
	<V> Long lInsert(final String key, final V value, final ListPosition position, final V pivot);
	 ...
	 * 如果没有找到 pivot ，返回 -1 ；如果 key 不存在或为空列表，返回 0 。
	 */
	<V> Long lInsert(final byte[] key, final V value, final ListPosition position, final V pivot);
	 ...
	 */
	<V> List<V> lRangeObject(final String key, final int start, final int end);
	 ...
	 * 如果 end 下标比最大下标还要大，那么最多返回到 end 个下标
	 */
	<V> List<V> lRangeObject(final byte[] key, final int start, final int end);
	 ...
	 * @see java.lang.Class
	 */
	<V> List<V> lRangeObject(final String key, final int start, final int end, final Class<V> clazz);
	 ...
	 * @see java.lang.Class
	 */
	<V> List<V> lRangeObject(final byte[] key, final int start, final int end, final Class<V> clazz);
	 ...
	 * @see com.buession.core.serializer.type.TypeReference
	 */
	<V> List<V> lRangeObject(final String key, final int start, final int end, final TypeReference<V> type);
	 ...
	 * @see com.buession.core.serializer.type.TypeReference
	 */
	<V> List<V> lRangeObject(final byte[] key, final int start, final int end, final TypeReference<V> type);
	 ...
	 */
	<V> Status lSet(final String key, final int index, final V value);
	 ...
	 * @return 操作结果；设置成功时返回 Status.Success，否则返回 Status.FAILURE
	 */
	<V> Status lSet(final byte[] key, final int index, final V value);
