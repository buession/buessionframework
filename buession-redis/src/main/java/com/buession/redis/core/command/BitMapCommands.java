...
public interface BitMapCommands extends RedisCommands {
	 ...
	 * @since 2.3.0
	 */
	List<Long> bitField(final String key, final BitFieldArgument... arguments);
	 ...
	 * @since 2.3.0
	 */
	List<Long> bitField(final byte[] key, final BitFieldArgument... arguments);
	 ...
	 * @return 返回值是一个数组，数组中的每个元素对应一个被执行的子命令
	 */
	List<Long> bitFieldRo(final String key, final BitFieldRoArgument... arguments);
	 ...
	 * @return 返回值是一个数组，数组中的每个元素对应一个被执行的子命令
	 */
	List<Long> bitFieldRo(final byte[] key, final BitFieldRoArgument... arguments);
	 ...
	 * @return 位图中第一个值为 bit 的二进制位的位置
	 */
	Long bitPos(final String key, final boolean value, final long start, final long end, final BitType type);
	 ...
	 * @return 位图中第一个值为 bit 的二进制位的位置
	 */
	Long bitPos(final byte[] key, final boolean value, final long start, final long end, final BitType type);
