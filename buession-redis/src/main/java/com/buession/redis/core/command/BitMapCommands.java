...
public interface BitMapCommands extends RedisCommands {
     ...
     *
     * <p>详情说明 <a href="http://redisdoc.com/bitmap/setbit.html" target="_blank">http://redisdoc.com/bitmap/setbit
     * .html</a></p>
     *
     * @param key
     *         Key
     ...
     */
    Long bitOp(final Operation operation, final String destKey, final String... keys);
     ...
     * @return 保存到 destKey 的字符串的长度
     */
    Long bitOp(final Operation operation, final byte[] destKey, final byte[]... keys);
     ...
     *
     * <p>详情说明 <a href="http://redisdoc.com/bitmap/bitcount.html" target="_blank">http://redisdoc.com/bitmap/bitcount
     * .html</a></p>
     *
     * @param key
     *         Key
