...
public class RedisTransactionException extends RedisException {
	...
	public RedisTransactionException(String message, Throwable cause, boolean enableSuppression,
									 boolean writableStackTrace) {
		this(message, cause, enableSuppression, writableStackTrace, ListBuilder.empty());
	}

	public RedisTransactionException(List<Object> results) {
		super("Transaction contained one or more invalid commands");
		this.results = Collections.unmodifiableList(results);
	}

	public RedisTransactionException(String message, List<Object> results) {
		super(message);
		this.results = Collections.unmodifiableList(results);
	}

	public RedisTransactionException(String message, Throwable cause, List<Object> results) {
		super(message, cause);
		this.results = Collections.unmodifiableList(results);
	}

	public RedisTransactionException(Throwable cause, List<Object> results) {
		super("Transaction contained one or more invalid commands", cause);
		this.results = Collections.unmodifiableList(results);
	}
