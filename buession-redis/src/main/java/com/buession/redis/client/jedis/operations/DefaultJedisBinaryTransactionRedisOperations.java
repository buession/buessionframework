 ...
 * @author Yong.Teng
 */
public class DefaultJedisBinaryTransactionRedisOperations<C extends BinaryJedisCommands> extends AbstractJedisBinaryRedisOperations implements JedisBinaryTransactionRedisOperations {

	public DefaultJedisBinaryTransactionRedisOperations(final JedisRedisClient client){
		super(client);
	}
