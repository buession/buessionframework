 ...
 * @since 2.0.0
 */
public final class JedisScriptingOperations extends AbstractJedisRedisOperations implements ScriptingOperations {

	public JedisScriptingOperations(final JedisRedisClient client) {
		super(client);
	}
