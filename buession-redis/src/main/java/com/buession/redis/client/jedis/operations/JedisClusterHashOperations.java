...
public final class JedisClusterHashOperations extends AbstractHashOperations<JedisClusterClient> {
	...
	public long hDel(final String key, final String... fields){
		...
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.HDEL)
	...
	public boolean hExists(final String key, final String field){
		...
		final JedisClusterCommand<Boolean> command = new JedisClusterCommand<Boolean>(client, ProtocolCommand.HEXISTS)
	...
	public String hGet(final String key, final String field){
		final CommandArguments args = CommandArguments.create("key", key).put("field", field);
		final JedisClusterCommand<String> command = new JedisClusterCommand<String>(client, ProtocolCommand.HGET)
	...
	public byte[] hGet(final byte[] key, final byte[] field){
		final CommandArguments args = CommandArguments.create("key", key).put("field", field);
		final JedisClusterCommand<byte[]> command = new JedisClusterCommand<byte[]>(client, ProtocolCommand.HGET)
				.general((cmd)->cmd.hget(key, field))
				.pipeline((cmd)->cmd.hget(key, field))
				.transaction((cmd)->cmd.hget(key, field));
		return execute(command, args);
	...
	public Map<String, String> hGetAll(final String key){
		...
		final JedisClusterCommand<Map<String, String>> command = new JedisClusterCommand<Map<String, String>>(client,
	...
	public Map<byte[], byte[]> hGetAll(final byte[] key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<Map<byte[], byte[]>> command = new JedisClusterCommand<Map<byte[], byte[]>>(client,
				ProtocolCommand.HGETALL)
				.general((cmd)->cmd.hgetAll(key))
				.pipeline((cmd)->cmd.hgetAll(key))
				.transaction((cmd)->cmd.hgetAll(key));
	...
	public long hIncrBy(final String key, final String field, final long value){
		...
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.HINCRBY)
	...
	public double hIncrByFloat(final String key, final String field, final double value){
		final CommandArguments args = CommandArguments.create("key", key).put("field", field).put("value", value);
		final JedisClusterCommand<Double> command = new JedisClusterCommand<Double>(client,
				ProtocolCommand.HINCRBYFLOAT)
	...
	public long hLen(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.HLEN)
	...
	public Status hMSet(final String key, final Map<String, String> data){
		...
		final JedisClusterCommand<Status> command = new JedisClusterCommand<Status>(client, ProtocolCommand.HMGET)
	...
	public String hRandField(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<String> command = new JedisClusterCommand<String>(client, ProtocolCommand.HRANDFIELD)
	...
	public byte[] hRandField(final byte[] key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<byte[]> command = new JedisClusterCommand<byte[]>(client, ProtocolCommand.HRANDFIELD)
				.general((cmd)->cmd.hrandfield(key))
				.pipeline((cmd)->cmd.hrandfield(key))
				.transaction((cmd)->cmd.hrandfield(key));
		return execute(command, args);
	...
	public ScanResult<Map<String, String>> hScan(final String key, final String cursor){
		...
		final JedisClusterCommand<ScanResult<Map<String, String>>> command = new JedisClusterCommand<ScanResult<Map<String, String>>>(
				client, ProtocolCommand.HSCAN)
				.general((cmd)->cmd.hscan(key, cursor),
	...
	public ScanResult<Map<byte[], byte[]>> hScan(final byte[] key, final byte[] cursor){
		final CommandArguments args = CommandArguments.create("key", key).put("cursor", cursor);
		final JedisClusterCommand<ScanResult<Map<byte[], byte[]>>> command = new JedisClusterCommand<ScanResult<Map<byte[], byte[]>>>(
				client, ProtocolCommand.HSCAN)
				.general((cmd)->cmd.hscan(key, cursor),
	...
	public long hSet(final byte[] key, final byte[] field, final byte[] value){
		final CommandArguments args = CommandArguments.create("key", key).put("field", field).put("value", value);
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.HSET)
				.general((cmd)->cmd.hset(key, field, value))
				.pipeline((cmd)->cmd.hset(key, field, value))
				.transaction((cmd)->cmd.hset(key, field, value));
		return execute(command, args);
	...
	public Status hSetNx(final String key, final String field, final String value){
		final CommandArguments args = CommandArguments.create("key", key).put("field", field).put("value", value);
		final JedisClusterCommand<Status> command = new JedisClusterCommand<Status>(client, ProtocolCommand.HSETNX)
	...
	public long hStrLen(final String key, final String field){
		final CommandArguments args = CommandArguments.create("key", key).put("field", field);
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.HSTRLEN)
