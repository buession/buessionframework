 ...
 * @author Yong.Teng
 */
public class DefaultGeoRedisOperations<C extends JedisCommands> extends AbstractJedisRedisOperations implements JedisGeoRedisOperations {

	public DefaultGeoRedisOperations(final JedisRedisClient client){
		super(client);
	}
