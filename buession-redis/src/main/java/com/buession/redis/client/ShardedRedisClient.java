...
public interface ShardedRedisClient extends RedisClient {
    ...
    @Override
    default Long zInterStore(final String destKey, final Aggregate aggregate, final double[] weights, final String...
            keys){
        throw new NotSupportedCommandException(ProtocolCommand.ZINTERSTORE);
    }

    @Override
    default Long zInterStore(final byte[] destKey, final Aggregate aggregate, final double[] weights, final byte[]...
            keys){
        throw new NotSupportedCommandException(ProtocolCommand.ZINTERSTORE);
    }
    ...
    @Override
    default Long zUnionStore(final String destKey, final Aggregate aggregate, final double[] weights, final String...
            keys){
        throw new NotSupportedCommandException(ProtocolCommand.ZUNIONSTORE);
    }

    @Override
    default Long zUnionStore(final byte[] destKey, final Aggregate aggregate, final double[] weights, final byte[]...
            keys){
        throw new NotSupportedCommandException(ProtocolCommand.ZUNIONSTORE);
    }
