 ...
 * @since 2.0.0
 */
public final class JedisStringOperations extends AbstractStringOperations<JedisConnection> {
	...
	public long append(final String key, final String value){
		...
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.APPEND)
	...
	public long incr(final String key){
		...
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.INCR)
	...
	public long incrBy(final String key, final long value){
		final CommandArguments args = CommandArguments.create("key", key).put("value", value);
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.INCRBY)
	...
	public double incrByFloat(final String key, final double value){
		final CommandArguments args = CommandArguments.create("key", key).put("value", value);
		final JedisCommand<Double> command = JedisCommand.<Double>create(ProtocolCommand.INCRBYFLOAT)
	...
	public long decr(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.DECR)
	...
	public long decrBy(final String key, final long value){
		final CommandArguments args = CommandArguments.create("key", key).put("value", value);
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.DECRBY)
	...
	public String get(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisCommand<String> command = JedisCommand.<String>create(ProtocolCommand.GET)
	...
	public byte[] get(final byte[] key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisCommand<byte[]> command = JedisCommand.<byte[]>create(ProtocolCommand.GET)
				.general((cmd)->cmd.get(key)).pipeline((cmd)->cmd.get(key))
				.transaction((cmd)->cmd.get(key));
		return execute(command, args);
	}
	...
	public String getEx(final String key, final GetExArgument getExArgument){
		...
		final JedisCommand<String> command = JedisCommand.<String>create(ProtocolCommand.GETEX)
	...
	public byte[] getEx(final byte[] key, final GetExArgument getExArgument){
		final CommandArguments args = CommandArguments.create("key", key).put("getExArgument", getExArgument);
		final GetExParams params = GetExArgumentConverter.INSTANCE.convert(getExArgument);
		final JedisCommand<byte[]> command = JedisCommand.<byte[]>create(ProtocolCommand.GETEX)
				.general((cmd)->cmd.getEx(key, params)).pipeline((cmd)->cmd.getEx(key, params))
				.transaction((cmd)->cmd.getEx(key, params));
		return execute(command, args);
	}
	...
	public String getSet(final String key, final String value){
		final CommandArguments args = CommandArguments.create("key", key).put("value", value);
		final JedisCommand<String> command = JedisCommand.<String>create(ProtocolCommand.GETSET)
	...
	public byte[] getSet(final byte[] key, final byte[] value){
		final CommandArguments args = CommandArguments.create("key", key).put("value", value);
		final JedisCommand<byte[]> command = JedisCommand.<byte[]>create(ProtocolCommand.GETSET)
				.general((cmd)->cmd.getSet(key, value)).pipeline((cmd)->cmd.getSet(key, value))
				.transaction((cmd)->cmd.getSet(key, value));
		return execute(command, args);
	}
	...
	public String getDel(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisCommand<String> command = JedisCommand.<String>create(ProtocolCommand.GETDEL)
	...
	public byte[] getDel(final byte[] key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisCommand<byte[]> command = JedisCommand.<byte[]>create(ProtocolCommand.GETDEL)
				.general((cmd)->cmd.getDel(key)).pipeline((cmd)->cmd.getDel(key)).transaction((cmd)->cmd.getDel(key));
		return execute(command, args);
	}
	...
	public List<String> mGet(final String... keys){
		...
		final JedisCommand<List<String>> command = JedisCommand.<List<String>>create(ProtocolCommand.MGET)
	...
	public List<byte[]> mGet(final byte[]... keys){
		final CommandArguments args = CommandArguments.create("keys", keys);
		final JedisCommand<List<byte[]>> command = JedisCommand.<List<byte[]>>create(ProtocolCommand.MGET)
				.general((cmd)->cmd.mget(keys)).pipeline((cmd)->cmd.mget(keys)).transaction((cmd)->cmd.mget(keys));
		return execute(command, args);
	}
	...
	public Status mSet(final Map<String, String> values){
		...
		final JedisCommand<Status> command = JedisCommand.<Status>create(ProtocolCommand.MSET)
	...
	public Status mSetNx(final Map<String, String> values){
		...
		final String[] keysValues = temp.toArray(new String[0]);
		final JedisCommand<Status> command = JedisCommand.<Status>create(ProtocolCommand.MSETNX)
	...
	public Status pSetEx(final String key, final String value, final int lifetime){
		...
		final JedisCommand<Status> command = JedisCommand.<Status>create(ProtocolCommand.PSETEX)
	...
	public Status set(final String key, final String value){
		final CommandArguments args = CommandArguments.create("key", key).put("value", value);
		final JedisCommand<Status> command = JedisCommand.<Status>create(ProtocolCommand.SET)
	...
	public Status setEx(final String key, final String value, final int lifetime){
		final CommandArguments args = CommandArguments.create("key", key).put("value", value).put("lifetime", lifetime);
		final JedisCommand<Status> command = JedisCommand.<Status>create(ProtocolCommand.SETEX)
	...
	public long setRange(final String key, final long offset, final String value){
		...
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.SETEX)
	...
	public String getRange(final String key, final long start, final long end){
		...
		final JedisCommand<String> command = JedisCommand.<String>create(ProtocolCommand.GETRANGE)
	...
	public byte[] getRange(final byte[] key, final long start, final long end){
		final CommandArguments args = CommandArguments.create("key", key).put("start", start).put("end", end);
		final JedisCommand<byte[]> command = JedisCommand.<byte[]>create(ProtocolCommand.GETRANGE)
				.general((cmd)->cmd.getrange(key, start, end)).pipeline((cmd)->cmd.getrange(key, start, end))
				.transaction((cmd)->cmd.getrange(key, start, end));
		return execute(command, args);
	}
	...
	public long strlen(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.STRLEN)
	...
	public String substr(final String key, final long start, final long end){
		final CommandArguments args = CommandArguments.create("key", key).put("start", start).put("end", end);
		final JedisCommand<String> command = JedisCommand.<String>create(ProtocolCommand.SUBSTR)
	...
	public byte[] substr(final byte[] key, final long start, final long end){
		final CommandArguments args = CommandArguments.create("key", key).put("start", start).put("end", end);
		final JedisCommand<byte[]> command = JedisCommand.<byte[]>create(ProtocolCommand.SUBSTR)
				.general((cmd)->cmd.substr(key, (int) start, (int) end))
				.pipeline((cmd)->cmd.substr(key, (int) start, (int) end))
				.transaction((cmd)->cmd.substr(key, (int) start, (int) end));
		return execute(command, args);
