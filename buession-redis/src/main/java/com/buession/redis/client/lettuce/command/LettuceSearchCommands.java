 ...
 * @since 4.0.0
 */
public final class LettuceSearchCommands extends AbstractLettuceRedisCommands implements SearchCommands {

	public LettuceSearchCommands(final LettuceRedisClient client) {
		super(client);
	}
