...
public final class LettuceClusterOperations extends AbstractClusterOperations<LettuceStandaloneClient> {
	...
	public String clusterMyId(){
		return new LettuceCommand<String>(client, ProtocolCommand.CLUSTER_MY_ID)
	...
	public Status clusterAddSlots(final int... slots){
		...
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_ADDSLOTS)
	...
	public List<ClusterSlot> clusterSlots(){
		return new LettuceCommand<List<ClusterSlot>>(client, ProtocolCommand.CLUSTER_SLOTS)
	...
	public Integer clusterCountFailureReports(final String nodeId){
		...
		return new LettuceCommand<Integer>(client, ProtocolCommand.CLUSTER_COUNTFAILUREREPORTS)
				.run(args);
	}
	...
	public Long clusterCountKeysInSlot(final int slot){
		...
		return new LettuceCommand<Long>(client, ProtocolCommand.CLUSTER_COUNTKEYSINSLOT)
	...
	public Status clusterDelSlots(final int... slots){
		final CommandArguments args = CommandArguments.create("slots", slots);
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_DELSLOTS)
	...
	public Status clusterFlushSlots(){
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_FLUSHSLOTS)
	...
	public Status clusterFailover(final ClusterFailoverOption clusterFailoverOption){
		...
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_FAILOVER)
	...
	public Status clusterForget(final String nodeId){
		final CommandArguments args = CommandArguments.create("nodeId", nodeId);
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_FORGET)
	...
	public List<String> clusterGetKeysInSlot(final int slot, final long count){
		...
		return new LettuceCommand<List<String>>(client, ProtocolCommand.CLUSTER_GETKEYSINSLOT)
	...
	public Long clusterKeySlot(final String key){
		...
		return new LettuceCommand<Long>(client, ProtocolCommand.CLUSTER_GETKEYSINSLOT)
	...
	public ClusterInfo clusterInfo(){
		return new LettuceCommand<ClusterInfo>(client, ProtocolCommand.CLUSTER_INFO)
	...
	public Status clusterMeet(final String ip, final int port){
		...
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_MEET)
	...
	public List<ClusterRedisNode> clusterNodes(){
		return new LettuceCommand<List<ClusterRedisNode>>(client, ProtocolCommand.CLUSTER_NODES)
	...
	public List<ClusterRedisNode> clusterSlaves(final String nodeId){
		final CommandArguments args = CommandArguments.create("nodeId", nodeId);
		return new LettuceCommand<List<ClusterRedisNode>>(client, ProtocolCommand.CLUSTER_SLAVES)
	...
	public List<ClusterRedisNode> clusterReplicas(final String nodeId){
		final CommandArguments args = CommandArguments.create("nodeId", nodeId);
		return new LettuceCommand<List<ClusterRedisNode>>(client, ProtocolCommand.CLUSTER_REPLICAS)
	...
	public Status clusterReplicate(final String nodeId){
		final CommandArguments args = CommandArguments.create("nodeId", nodeId);
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_REPLICATE)
	...
	public Status clusterReset(final ClusterResetOption clusterResetOption){
		...
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_RESET)
	...
	public Status clusterSaveConfig(){
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_SAVECONFIG)
	...
	public Status clusterSetConfigEpoch(final long configEpoch){
		...
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_SETCONFIGEPOCH)
	...
	public KeyValue<BumpEpoch, Integer> clusterBumpEpoch(){
		return new LettuceCommand<KeyValue<BumpEpoch, Integer>>(client, ProtocolCommand.CLUSTER_BUMPEPOCH)
	...
	public Status clusterSetSlot(final int slot, final ClusterSetSlotOption setSlotOption, final String nodeId){
		final CommandArguments args = CommandArguments.create("slot", slot).put("setSlotOption", setSlotOption)
				.put("nodeId", nodeId);
		return new LettuceCommand<Status>(client, ProtocolCommand.CLUSTER_SETSLOT)
				.general((cmd)->{
	...
	public Status asking(){
		return new LettuceCommand<Status>(client, ProtocolCommand.ASKING)
	...
	public Status readWrite(){
		return new LettuceCommand<Status>(client, ProtocolCommand.READWRITE)
	...
	public Status readOnly(){
		return new LettuceCommand<Status>(client, ProtocolCommand.READONLY)
