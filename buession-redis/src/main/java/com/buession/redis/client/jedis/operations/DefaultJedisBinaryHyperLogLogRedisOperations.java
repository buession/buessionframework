 ...
 * @author Yong.Teng
 */
public class DefaultJedisBinaryHyperLogLogRedisOperations<C extends BinaryJedisCommands> extends AbstractJedisBinaryRedisOperations implements JedisBinaryHyperLogLogRedisOperations {

	public DefaultJedisBinaryHyperLogLogRedisOperations(final JedisRedisClient client){
		super(client);
	}
