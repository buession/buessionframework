...
public final class LettucePubSubOperations extends AbstractPubSubOperations<LettuceStandaloneClient> {
	...
	public void pSubscribe(final String[] patterns, final PubSubListener<String> pubSubListener){
		...
		new LettuceCommand<Void>(client, ProtocolCommand.PSUBSCRIBE)
				.general((cmd)->{
	...
	public Long publish(final String channel, final String message){
		...
		return new LettuceCommand<Long>(client, ProtocolCommand.PUBLISH)
	...
	public List<String> pubsubChannels(){
		return new LettuceCommand<List<String>>(client, ProtocolCommand.PUBSUB_CHANNELS)
	...
	public List<byte[]> pubsubChannels(final byte[] pattern){
		final CommandArguments args = CommandArguments.create("pattern", pattern);
		return new LettuceCommand<List<byte[]>>(client, ProtocolCommand.PUBSUB_CHANNELS)
	...
	public Long pubsubNumPat(){
		return new LettuceCommand<Long>(client, ProtocolCommand.PUBSUB_NUMPAT)
	...
	public Map<String, Long> pubsubNumSub(final String... channels){
		...
		return new LettuceCommand<Map<String, Long>>(client, ProtocolCommand.PUBSUB_NUMSUB)
	...
	public Map<byte[], Long> pubsubNumSub(final byte[]... channels){
		final CommandArguments args = CommandArguments.create("channels", channels);
		return new LettuceCommand<Map<byte[], Long>>(client, ProtocolCommand.PUBSUB_NUMSUB)
				.general((cmd)->{
	...
	public void subscribe(final String[] channels, final PubSubListener<String> pubSubListener){
		final CommandArguments args = CommandArguments.create("channels", channels)
				.put("pubSubListener", pubSubListener);
		new LettuceCommand<String>(client, ProtocolCommand.PUBLISH)
				.general((cmd)->{
