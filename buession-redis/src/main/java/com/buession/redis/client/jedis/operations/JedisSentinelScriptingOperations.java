 ...
 * @author Yong.Teng
 */
public final class JedisSentinelScriptingOperations extends AbstractScriptingOperations<Jedis> {
	...
	public List<Boolean> scriptExists(final String... sha1){
		...
		if(isPipeline()){
			return execute(CommandNotSupported.PIPELINE, ProtocolCommand.SCRIPT_EXISTS, args);
		}else if(isTransaction()){
