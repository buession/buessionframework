 ...
 * @since 2.0.0
 */
public final class JedisSetOperations extends AbstractJedisRedisOperations implements SetOperations {

	public JedisSetOperations(final JedisRedisClient client) {
		super(client);
	}
