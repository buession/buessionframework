 ...
 * @since 2.0.0
 */
public final class JedisClusterSortedSetOperations extends AbstractSortedSetOperations<JedisClusterConnection> {
	...
	public Tuple zPopMin(final String key){
		...
		final JedisClusterCommand<Tuple> command = JedisClusterCommand.<Tuple>create(ProtocolCommand.ZPOPMIN)
	...
	public List<Tuple> zPopMin(final String key, final long count){
		...
		final JedisClusterCommand<List<Tuple>> command = JedisClusterCommand.<List<Tuple>>create(
	...
	public Tuple zPopMax(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<Tuple> command = JedisClusterCommand.<Tuple>create(ProtocolCommand.ZPOPMAX)
	...
	public KeyedZSetElement bzPopMin(final String[] keys, final int timeout){
		...
		final JedisClusterCommand<KeyedZSetElement> command = JedisClusterCommand.<KeyedZSetElement>create(
	...
	public long zAdd(final String key, final Map<String, Double> members){
		...
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZADD)
	...
	public long zCard(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZCARD)
	...
	public long zCount(final String key, final double min, final double max){
		...
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZCOUNT)
	...
	public Set<String> zDiff(final String... keys){
		...
		final JedisClusterCommand<Set<String>> command = JedisClusterCommand.<Set<String>>create(ProtocolCommand.ZDIFF)
	...
	public Set<byte[]> zDiff(final byte[]... keys){
		final CommandArguments args = CommandArguments.create("keys", keys);
		final JedisClusterCommand<Set<byte[]>> command = JedisClusterCommand.<Set<byte[]>>create(ProtocolCommand.ZDIFF)
				.general((cmd)->cmd.zdiff(keys)).pipeline((cmd)->cmd.zdiff(keys)).transaction((cmd)->cmd.zdiff(keys));
		return execute(command, args);
	}
	...
	public Set<Tuple> zDiffWithScores(final String... keys){
		final CommandArguments args = CommandArguments.create("keys", keys);
		final JedisClusterCommand<Set<Tuple>> command = JedisClusterCommand.<Set<Tuple>>create(ProtocolCommand.ZDIFF)
	...
	public long zDiffStore(final String destKey, final String... keys){
		...
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZDIFFSTORE)
	...
	public double zIncrBy(final String key, final double increment, final String member){
		final CommandArguments args = CommandArguments.create("key", key).put("increment", increment)
				.put("member", member);
		final JedisClusterCommand<Double> command = JedisClusterCommand.<Double>create(ProtocolCommand.ZINCRBY)
	...
	public Set<String> zInter(final String... keys){
		...
		final JedisClusterCommand<Set<String>> command = JedisClusterCommand.<Set<String>>create(ProtocolCommand.ZINTER)
	...
	public Set<byte[]> zInter(final byte[]... keys){
		final CommandArguments args = CommandArguments.create("keys", keys);
		final ZParams params = new JedisZParams();
		final JedisClusterCommand<Set<byte[]>> command = JedisClusterCommand.<Set<byte[]>>create(ProtocolCommand.ZINTER)
				.general((cmd)->cmd.zinter(params, keys)).pipeline((cmd)->cmd.zinter(params, keys))
				.transaction((cmd)->cmd.zinter(params, keys));
		return execute(command, args);
	}
	...
	public Set<Tuple> zInterWithScores(final String... keys){
		final CommandArguments args = CommandArguments.create("keys", keys);
		final ZParams params = new JedisZParams();
		final JedisClusterCommand<Set<Tuple>> command = JedisClusterCommand.<Set<Tuple>>create(ProtocolCommand.ZINTER)
	...
	public long zInterStore(final String destKey, final String... keys){
		final CommandArguments args = CommandArguments.create("destKey", destKey).put("keys", keys);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZINTERSTORE)
	...
	public long zLexCount(final String key, final double min, final double max){
		final CommandArguments args = CommandArguments.create("key", key).put("min", min).put("max", max);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZLEXCOUNT)
	...
	public List<Double> zMScore(final String key, final String... members){
		...
		final JedisClusterCommand<List<Double>> command = JedisClusterCommand.<List<Double>>create(
	...
	public String zRandMember(final String key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<String> command = JedisClusterCommand.<String>create(ProtocolCommand.ZRANDMEMBER)
	...
	public byte[] zRandMember(final byte[] key){
		final CommandArguments args = CommandArguments.create("key", key);
		final JedisClusterCommand<byte[]> command = JedisClusterCommand.<byte[]>create(ProtocolCommand.ZRANDMEMBER)
				.general((cmd)->cmd.zrandmember(key)).pipeline((cmd)->cmd.zrandmember(key))
				.transaction((cmd)->cmd.zrandmember(key));
		return execute(command, args);
	}
	...
	public List<Tuple> zRangeWithScores(final String key, final long start, final long end){
		final CommandArguments args = CommandArguments.create("key", key).put("start", start).put("end", end);
		final JedisClusterCommand<List<Tuple>> command = JedisClusterCommand.<List<Tuple>>create(ProtocolCommand.ZRANGE)
	...
	public long zRangeStore(final String destKey, final String key, final long start, final long end){
		...
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZRANGESTORE)
	...
	public Long zRank(final String key, final String member){
		...
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZRANK)
	...
	public long zRem(final String key, final String... members){
		final CommandArguments args = CommandArguments.create("key", key).put("members", members);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZREM)
	...
	public long zRemRangeByLex(final String key, final String min, final String max){
		final CommandArguments args = CommandArguments.create("key", key).put("min", min).put("max", max);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZREMRANGEBYLEX)
	...
	public long zRemRangeByScore(final String key, final double min, final double max){
		final CommandArguments args = CommandArguments.create("key", key).put("min", min).put("max", max);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZREMRANGEBYSCORE)
	...
	public long zRemRangeByRank(final String key, final long start, final long end){
		final CommandArguments args = CommandArguments.create("key", key).put("start", start).put("end", end);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZREMRANGEBYRANK)
	...
	public long zRevRank(final String key, final String member){
		final CommandArguments args = CommandArguments.create("key", key).put("member", member);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZREVRANK)
	...
	public ScanResult<List<Tuple>> zScan(final String key, final String cursor){
		...
		final JedisClusterCommand<ScanResult<List<Tuple>>> command = JedisClusterCommand.<ScanResult<List<Tuple>>>create(
	...
	public Double zScore(final String key, final String member){
		final CommandArguments args = CommandArguments.create("key", key).put("member", member);
		final JedisClusterCommand<Double> command = JedisClusterCommand.<Double>create(ProtocolCommand.ZSCORE)
	...
	public Set<String> zUnion(final String... keys){
		...
		final JedisClusterCommand<Set<String>> command = JedisClusterCommand.<Set<String>>create(ProtocolCommand.ZUNION)
	...
	public Set<byte[]> zUnion(final byte[]... keys){
		final CommandArguments args = CommandArguments.create("keys", keys);
		final JedisZParams params = new JedisZParams();
		final JedisClusterCommand<Set<byte[]>> command = JedisClusterCommand.<Set<byte[]>>create(ProtocolCommand.ZUNION)
				.general((cmd)->cmd.zunion(params, keys)).pipeline((cmd)->cmd.zunion(params, keys))
				.transaction((cmd)->cmd.zunion(params, keys));
		return execute(command, args);
	}
	...
	public Set<Tuple> zUnionWithScores(final String... keys){
		final CommandArguments args = CommandArguments.create("keys", keys);
		final JedisZParams params = new JedisZParams();
		final JedisClusterCommand<Set<Tuple>> command = JedisClusterCommand.<Set<Tuple>>create(ProtocolCommand.ZUNION)
	...
	public long zUnionStore(final String destKey, final String... keys){
		final CommandArguments args = CommandArguments.create("destKey", destKey).put("keys", keys);
		final JedisClusterCommand<Long> command = JedisClusterCommand.<Long>create(ProtocolCommand.ZUNIONSTORE)
