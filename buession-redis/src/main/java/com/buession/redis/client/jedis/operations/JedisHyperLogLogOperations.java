 ...
 * @since 2.0.0
 */
public final class JedisHyperLogLogOperations extends AbstractHyperLogLogOperations<JedisConnection> {
	...
	public Status pfAdd(final String key, final String... elements){
		...
		final JedisCommand<Status> command = JedisCommand.<Status>create(ProtocolCommand.PFADD)
	...
	public long pfCount(final String... keys){
		...
		final JedisCommand<Long> command = JedisCommand.<Long>create(ProtocolCommand.PFCOUNT)
