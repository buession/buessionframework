...
public final class JedisHyperLogLogOperations extends AbstractHyperLogLogOperations<JedisStandaloneClient> {
	...
	public Status pfAdd(final String key, final String... elements){
		...
		final JedisCommand<Status> command = new JedisCommand<Status>(client, ProtocolCommand.PFADD)
	...
	public Status pfMerge(final String destKey, final String... keys){
		...
		final JedisCommand<Status> command = new JedisCommand<Status>(client, ProtocolCommand.PFMERGE)
	...
	public long pfCount(final String... keys){
		...
		final JedisCommand<Long> command = new JedisCommand<Long>(client, ProtocolCommand.PFCOUNT)
