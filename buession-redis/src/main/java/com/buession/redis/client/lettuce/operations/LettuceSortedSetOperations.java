 ...
 * @since 3.0.0
 */
public final class LettuceSortedSetOperations extends AbstractLettuceRedisOperations implements SortedSetOperations {

	public LettuceSortedSetOperations(final LettuceRedisClient client) {
		super(client);
	}
