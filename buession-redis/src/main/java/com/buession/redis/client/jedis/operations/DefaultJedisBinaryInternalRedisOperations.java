 ...
 * @author Yong.Teng
 */
public class DefaultJedisBinaryInternalRedisOperations<C extends BinaryJedisCommands> extends AbstractJedisBinaryRedisOperations implements JedisBinaryInternalRedisOperations {

	public DefaultJedisBinaryInternalRedisOperations(final JedisRedisClient client){
		super(client);
	}
