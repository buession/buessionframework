 ...
 * @since 3.0.0
 */
public final class LettuceStringOperations extends AbstractLettuceRedisOperations implements StringOperations {

	public LettuceStringOperations(final LettuceRedisClient client) {
		super(client);
	}
