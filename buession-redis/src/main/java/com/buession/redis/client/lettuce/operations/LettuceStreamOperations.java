 ...
 * @since 3.0.0
 */
public final class LettuceStreamOperations extends AbstractLettuceRedisOperations implements StreamOperations {

	public LettuceStreamOperations(final LettuceRedisClient client) {
		super(client);
	}
