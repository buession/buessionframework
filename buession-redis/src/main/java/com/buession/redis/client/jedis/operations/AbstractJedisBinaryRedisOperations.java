...
import com.buession.redis.client.operations.AbstractBinaryRedisOperations;
 ...
 * @author Yong.Teng
 */
public abstract class AbstractJedisBinaryRedisOperations extends AbstractBinaryRedisOperations<JedisRedisClient> {

	public AbstractJedisBinaryRedisOperations(final JedisRedisClient client){
		super(client);
	}
