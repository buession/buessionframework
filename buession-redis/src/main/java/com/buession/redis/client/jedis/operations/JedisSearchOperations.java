 ...
 * @since 4.0.0
 */
public final class JedisSearchOperations extends AbstractJedisRedisOperations implements SearchOperations {

	public JedisSearchOperations(final JedisRedisClient client) {
		super(client);
	}
