...
public final class LettuceBitMapOperations extends AbstractBitMapOperations<LettuceStandaloneClient> {
	...
	public Long bitCount(final byte[] key){
		...
		return new LettuceCommand<Long>(client, ProtocolCommand.BITCOUNT)
	...
	public List<Long> bitField(final String key, final String... arguments){
		return bitField(SafeEncoder.encode(key), start, end, bitCountOption);
	}

	@Override
	public List<Long> bitField(final byte[] key, final byte[]... arguments){
		final CommandArguments args = CommandArguments.create("key", key).put("arguments", arguments);
		return new LettuceCommand<List<Long>>(client, ProtocolCommand.BITFIELD)
	...
	public List<Long> bitFieldRo(final String key, final String... arguments){
		final CommandArguments args = CommandArguments.create("key", key).put("arguments", arguments);
		return new LettuceCommand<List<Long>>(client, ProtocolCommand.BITFIELD_RO)
	...
	public Long bitOp(final BitOperation operation, final String destKey, final String... keys){
		...
		return new LettuceCommand<Long>(client, ProtocolCommand.BITOP)
	...
	public Long bitPos(final String key, final boolean value){
		...
		return new LettuceCommand<Long>(client, ProtocolCommand.BITPOS)
	...
	public Boolean getBit(final String key, final long offset){
		...
		return new LettuceCommand<Boolean>(client, ProtocolCommand.GETBIT)
	...
	public Boolean setBit(final String key, final long offset, final boolean value){
		...
		return new LettuceCommand<Boolean>(client, ProtocolCommand.SETBIT)
