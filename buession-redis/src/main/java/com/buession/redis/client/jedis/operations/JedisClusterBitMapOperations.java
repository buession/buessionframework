...
public final class JedisClusterBitMapOperations extends AbstractBitMapOperations<JedisClusterClient> {
	...
	public long bitCount(final String key){
		...
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.BITCOUNT)
	...
	public long bitOp(final BitOperation operation, final String destKey, final String... keys){
		...
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.BITOP)
	...
	public long bitPos(final String key, final boolean value){
		...
		final JedisClusterCommand<Long> command = new JedisClusterCommand<Long>(client, ProtocolCommand.BITPOS)
	...
	public boolean getBit(final String key, final long offset){
		...
		final JedisClusterCommand<Boolean> command = new JedisClusterCommand<Boolean>(client, ProtocolCommand.GETBIT)
	...
	public boolean setBit(final String key, final long offset, final boolean value){
		...
		final JedisClusterCommand<Boolean> command = new JedisClusterCommand<Boolean>(client, ProtocolCommand.SETBIT)
