...
public interface KeyCommands extends RedisCommands {
	 ...
	 * 获取给定 key 的剩余生存时间
	 *
	 * <p>详情说明 <a href="http://redisdoc.com/expire/pttl.html" target="_blank">http://redisdoc.com/expire/pttl
	 * .html</a></p>
	 *
	 * @param key
	 * 		Key
	 ...
	 *
	 * <p>详情说明
	 * <a href="http://redisdoc.com/internal/restore.html" target="_blank">http://redisdoc.com/internal/restore
	 * .html</a>
	 * </p>
	 *
	 * @param key
