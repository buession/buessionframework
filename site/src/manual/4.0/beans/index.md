...
该模块将不再推荐，将在未来版本中，彻底删除。属性拷贝推荐使用 spring BeanWrapper 或者 org.mapstruct:mapstruct(https://mvnrepository.com/artifact/org.mapstruct/mapstruct) 。
...
### [API 参考手册>>](https://javadoc.io/doc/com.buession/buession-beans/4.0.0/index.html)