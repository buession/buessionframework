 ...
 * @author Yong.Teng
 */
public class ServletPrimitiveCrossOriginAnnotationMethodInterceptor extends
    ...
    public ServletPrimitiveCrossOriginAnnotationMethodInterceptor(AnnotationResolver resolver){
