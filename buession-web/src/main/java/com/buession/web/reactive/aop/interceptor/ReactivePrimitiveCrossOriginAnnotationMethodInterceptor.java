 ...
 * @author Yong.Teng
 */
public class ReactivePrimitiveCrossOriginAnnotationMethodInterceptor extends
        AbstractPrimitiveCrossOriginAnnotationMethodInterceptor {

    public ReactivePrimitiveCrossOriginAnnotationMethodInterceptor(){
        super(new ReactivePrimitiveCrossOriginAnnotationHandler());
    }

    public ReactivePrimitiveCrossOriginAnnotationMethodInterceptor(AnnotationResolver resolver){
