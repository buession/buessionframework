...
/**
 * <a href="https://developer.mozilla.org/zh-CN/docs/Web/HTTP/CORS" target="_blank">跨源资源共享（CORS）</a> 过滤器
 *
 * @author Yong.Teng
 * @since 2.0.0
 */
public class CorsFilter implements WebFilter {
	...
	private CorsConfig.Builder corsConfigBuilder = CorsConfig.Builder.create();
	...
	public void setOrigins(Set<String> origins){
		...
		corsConfigBuilder.origins(origins);
	}
	...
	public void setAllowedMethods(Set<HttpMethod> allowedMethods){
		...
		corsConfigBuilder.allowedMethods(allowedMethods);
	}
	...
	public void setAllowedHeaders(Set<String> allowedHeaders){
		...
		corsConfigBuilder.allowedHeaders(allowedHeaders);
	}
	...
	public void setExposedHeaders(Set<String> exposedHeaders){
		...
		corsConfigBuilder.exposedHeaders(exposedHeaders);
	}
	...
	public void setAllowCredentials(Boolean allowCredentials){
		...
		corsConfigBuilder.allowCredentials(allowCredentials);
	}
	...
	public void setMaxAge(Long maxAge){
		this.maxAge = maxAge;
		corsConfigBuilder.maxAge(maxAge);
	}

	@Override
	public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain){
		ResponseUtils.cors(corsConfigBuilder.build(), exchange.getRequest(), exchange.getResponse());
