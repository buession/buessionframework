...
public class ThesaurusNotFoundException extends DataNotFoundException {
    ...
    public ThesaurusNotFoundException(String message){
        super(message);
    }

    public ThesaurusNotFoundException(String message, Throwable cause){
        super(message, cause);
    }

    public ThesaurusNotFoundException(Throwable cause){
        super(cause);
    }
}
