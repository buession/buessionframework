...
public class ThesaurusTypeNotFoundException extends DataNotFoundException {
    ...
    public ThesaurusTypeNotFoundException(String message){
        super(message);
    }

    public ThesaurusTypeNotFoundException(String message, Throwable cause){
        super(message, cause);
    }

    public ThesaurusTypeNotFoundException(Throwable cause){
        super(cause);
    }
