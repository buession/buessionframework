...
import com.buession.socket.utils.ByteBufToBytes;
...
public class ByteMessageDecoder extends ByteToMessageDecoder {
	...
	private final static Logger logger = LoggerFactory.getLogger(ByteMessageDecoder.class);
	...
	protected void decode(ChannelHandlerContext context, ByteBuf in, List<Object> out)
		...
		logger.debug("Decoder byte message: {} width context: {}.", new String(data), context);
