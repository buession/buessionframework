...
public class ChunkedInputStreamEntity extends AbstractHttpEntity {
	...
	public ChunkedInputStreamEntity(final InputStream inputStream) {
		this(inputStream, -1);
	}

	public ChunkedInputStreamEntity(final InputStream inputStream, final long length) {
		this(inputStream, length, null);
	}

	public ChunkedInputStreamEntity(final InputStream inputStream, final ContentType contentType) {
		this(inputStream, -1, contentType);
	}

	public ChunkedInputStreamEntity(final InputStream inputStream, final long length, final ContentType contentType) {
		super();
