...
/**
 * Apache HttpClient application/x-www-form-urlencoded 表单请求体转换器
 *
 * @author Yong.Teng
 */
public class ApacheEncodedFormRequestBodyConverter
		implements ApacheRequestBodyConverter<EncodedFormRequestBody>, EncodedFormRequestBodyConverter<HttpEntity> {
