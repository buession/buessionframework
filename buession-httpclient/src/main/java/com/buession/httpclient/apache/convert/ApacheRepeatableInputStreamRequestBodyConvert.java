 ...
 * @since 1.2.0
 */
public class ApacheRepeatableInputStreamRequestBodyConvert
		implements ApacheRequestBodyConverter<RepeatableInputStreamRequestBody>,
		RepeatableInputStreamRequestBodyConvert<HttpEntity> {
