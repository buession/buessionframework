 ...
 * @author Yong.Teng
 */
public class Apache5TextRawRequestBodyConverter extends BaseRawRequestBodyConverter<TextRawRequestBody>
		implements TextRawRequestBodyConverter<HttpEntity> {
