 ...
 * @author Yong.Teng
 */
public class Apache5MultipartFormRequestBodyConverter implements Apache5RequestBodyConverter<MultipartFormRequestBody>,
		MultipartFormRequestBodyConverter<HttpEntity> {
