 ...
 * @author Yong.Teng
 */
public class OkHttpTextRawRequestBodyConverter extends BaseRawRequestBodyConverter<TextRawRequestBody>
		implements TextRawRequestBodyConverter<okhttp3.RequestBody> {
