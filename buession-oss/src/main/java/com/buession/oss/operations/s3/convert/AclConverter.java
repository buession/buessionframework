 ...
 * @since 2.0.0
 */
public interface AclConverter<S, T> extends Converter<S, T> {
	...
	final class BuessionToAliCloudOSSConverter
			implements AclConverter<Acl, CannedAccessControlList> {
	...
	final class AliCloudOSSToBuessionConverter
			implements AclConverter<CannedAccessControlList, Acl> {
